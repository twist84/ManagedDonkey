...
extern void __cdecl observer_command_get_collision_ignore_objects(int32 user_index, s_observer_command const* command, int32* out_first_ignore_object_index, int32* out_second_ignore_object_index);
...
extern void __cdecl observer_perform_collision(int32 user_index, s_focus_and_distance const* focus_and_distance, real32 world_seconds_elapsed);
...
extern void __cdecl observer_result_set_position(int32 user_index, real_point3d const* position, real32 distance, real_vector3d const* forward);
...
extern s_observer_result const* __cdecl observer_try_and_get_camera(int32 user_index);
