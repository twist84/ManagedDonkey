...
//.text:0072BFE0 ; real __cdecl calculate_field_of_view(real)
//.text:0072C040 ; void __cdecl camera_render_main_camera_to_texture_camera(bool)
//.text:0072C060 ; void __cdecl cinematic_camera_set_easing_in(real, real, real, real, real, real)
//.text:0072C170 ; void __cdecl cinematic_camera_set_easing_out(real)
...
//.text:0072C3D0 ; public: real __cdecl c_camera_pan_navigator::evaluate(long)
...
//.text:0072D3B0 ; void __cdecl scripted_camera_pan(short, short, short, short, real, short, real)
...
//.text:0072D710 ; void __cdecl scripted_camera_set_animation_relative_with_speed(long, long, long, short, real)
//.text:0072D740 ; void __cdecl scripted_camera_set_animation_relative_with_speed_loop(long, long, long, short, real, bool)
//.text:0072D770 ; void __cdecl scripted_camera_set_animation_relative_with_speed_loop_offset(long, long, long, short, real, bool, real)
...
//.text:0072EFA0 ; public: bool __cdecl c_camera_pan_navigator::set_parameters(real, real, real, real, real)
//.text:0072F0E0 ; void __cdecl transform_into_flag_space(real_matrix4x3*, long)
//.text:0072F150 ; public: virtual void __cdecl c_scripted_camera::update(long, real, s_observer_command*)
