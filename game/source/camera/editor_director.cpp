...
void __cdecl editor_director_set_position(const real_point3d* position, real_euler_angles2d* facing)
{
...
void c_editor_director::set_position_and_roll(const real_point3d* position, const real_euler_angles2d* facing)
{
