...
void __cdecl editor_director_set_position(real_point3d const* position, euler_angles2d* facing)
{
...
void c_editor_director::set_position_and_roll(real_point3d const* position, euler_angles2d const* facing)
{
