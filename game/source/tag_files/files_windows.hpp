...
extern uns32 __cdecl file_get_eof(s_file_reference const* reference);
...
extern uns32 __cdecl file_get_position(s_file_reference const* reference);
...
extern bool __cdecl file_write(s_file_reference* reference, uns32 size, void const* buffer);
extern bool __cdecl file_write_to_position(s_file_reference* reference, uns32 offset, uns32 size, void const* buffer);
...
extern void __cdecl find_files_start(s_find_file_data* data, uns32 flags, s_file_reference const* file);
extern void __cdecl find_files_start_with_search_spec(s_find_file_data* data, uns32 flags, s_file_reference const* file, char const* search_spec);
