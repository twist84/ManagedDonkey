...
extern uint32 __cdecl file_get_eof(s_file_reference const* reference);
...
extern uint32 __cdecl file_get_position(s_file_reference const* reference);
extern bool __cdecl file_get_size(s_file_reference* reference, uint32* out_file_size);
...
extern bool __cdecl file_set_eof(s_file_reference* reference, uint32 offset);
extern bool __cdecl file_set_position(s_file_reference* reference, uint32 offset, bool print_error);
extern bool __cdecl file_set_writeable(s_file_reference* reference, bool writeable);
extern bool __cdecl file_write(s_file_reference* reference, uint32 size, void const* buffer);
extern bool __cdecl file_write_to_position(s_file_reference* reference, uint32 offset, uint32 size, void const* buffer);
...
extern void __cdecl find_files_start(s_find_file_data* data, uint32 flags, s_file_reference const* file);
extern void __cdecl find_files_start_with_search_spec(s_find_file_data* data, uint32 flags, s_file_reference const* file, char const* search_spec);
...
extern void find_files_recursive(s_file_reference* directory, uint32 open_flags, bool(*file_handler)(s_file_reference*));
