...
extern char* __cdecl file_reference_get_name(s_file_reference const* reference, uns32 flags, char* out_name, int32 name_length);
extern wchar_t* __cdecl file_reference_get_name_wide(s_file_reference const* reference, uns32 flags, wchar_t* out_name, int32 name_length);
...
extern int32 __cdecl find_files(uns32 flags, s_file_reference const* directory, int32 maximum_count, s_file_reference* references);
