...
//extern long __cdecl find_files(unsigned long, s_file_reference const*, long, s_file_reference*);
//extern bool __cdecl file_is_readable(s_file_reference*, unsigned long*);
//extern void __cdecl file_trim(s_file_reference*, long);
//extern void* __cdecl file_read_into_memory_with_null_padding(s_file_reference*, unsigned long*, unsigned long);
//extern void* __cdecl file_read_into_memory(s_file_reference*, unsigned long*);
//extern bool __cdecl file_read_into_buffer(s_file_reference*, void*, unsigned long);
