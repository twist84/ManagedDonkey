...
extern bool __cdecl file_is_readable(s_file_reference* reference, uint32* error);
extern void __cdecl file_printf(s_file_reference* reference, char const* format, ...);
extern bool __cdecl file_read_into_buffer(s_file_reference* reference, void* buffer, uint32 buffer_length);
extern void* __cdecl file_read_into_memory(s_file_reference* reference, uint32* out_size);
