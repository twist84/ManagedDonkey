...
struct c_tag_resource_page_table
{
	...
	dword m_total_prefetch_bytes;
	dword m_current_prefetch_bytes;
...
{
	dword offset;
	dword unaligned_read_size;
	dword used_storage_size;
...
//protected:
	...
	dword m_total_request_size;
	dword m_finished_io_request_size;
	dword __unknown14844;
	dword __unknown14848;
	dword m_outstanding_request_count;
