...
void __cdecl c_atmosphere_fog_interface::dispose_from_old_structure_bsp(dword deactivating_structure_bsp_mask)
{
...
void __cdecl c_atmosphere_fog_interface::initialize_for_new_structure_bsp(dword activating_structure_bsp_mask)
{
