...
struct object_type_definition
{
	...
	void(__cdecl* datum_place)(int32 object_index, void const* scenario_object);
	...
	int32(__cdecl* datum_compute_activation)(int32 object_index, s_game_cluster_bit_vectors const* cluster_activation, bool* out_active);
	...
	void(__cdecl* datum_preprocess_node_orientations)(int32 object_index, c_static_flags<256> const* node_mask, int32 node_orientation_count, real_orientation* node_orientations);
