...
//.text:00B9B3D0 ; void __cdecl light_build_intermediate_geometry(real_point3d const*, real_point3d const*, real_vector3d const*, real_vector3d const*, real32, long, light_geometry*)
...
//.text:00B9C490 ; void __cdecl light_get_bounding_sphere(long, real_point3d*, real32*)
...
//.text:00B9CAB0 ; void __cdecl light_get_lod_sphere(long, real_point3d*, real32*)
...
//.text:00B9D120 ; long __cdecl light_new_unattached(long, long, short, real_point3d const*, real_vector3d const*, real_vector3d const*, real32)
//.text:00B9D300 ; real32 __cdecl light_prepare_for_window(long, long, real_matrix4x3*, real32)
