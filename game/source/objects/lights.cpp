...
//.text:00B9B3D0 ; void __cdecl light_build_intermediate_geometry(real_point3d const*, real_point3d const*, real_vector3d const*, real_vector3d const*, real32, int32, light_geometry*)
//.text:00B9B6F0 ; bool __cdecl light_build_render_geometry(int32, light_geometry*)
//.text:00B9B7C0 ; void __cdecl light_build_visibility_projections(real_vector3d const*, real_vector3d const*, light_geometry const*, visibility_projection*, int16*)
...
//.text:00B9C2B0 ; bool __cdecl light_find_valid_point(real_point3d const*, real_point3d const*, real_point3d*, real32*)
...
//.text:00B9CD80 ; int32 __cdecl light_new_from_scenario(int32, int32, bool, s_scenario_light const*)
//.text:00B9D120 ; int32 __cdecl light_new_unattached(int32, int32, int16, real_point3d const*, real_vector3d const*, real_vector3d const*, real32)
...
//.text:00B9E510 ; void __cdecl lights_dispose_from_old_structure_bsp(uint32)
...
//.text:00B9E920 ; void __cdecl lights_initialize_for_new_structure_bsp(uint32)
