...
protected:
	void object_iterator_begin_internal(uint32 type_flags, uint32 header_flags, uint32 iteration_match_flags, int32 next_absolute_index);
...
struct object_placement_data
{
	...
	s_damage_owner damage_owner;
	c_flags<int32, uint32, 5> change_color_override_mask;
...
extern void* __cdecl object_header_block_get(int32 object_index, object_header_block_reference const* reference);
extern void* __cdecl object_header_block_get_with_count(int32 object_index, object_header_block_reference const* reference, unsigned int element_size, int32* element_count);
extern object_header_datum const* __cdecl object_header_get(int32 object_index);
...
extern void* __cdecl object_get_and_verify_type(int32 object_index, uint32 object_type_mask);
...
extern int32 __cdecl cluster_get_first_collideable_object_and_payload(int32* datum_index, s_cluster_reference cluster_reference, s_object_cluster_payload const** payload);
extern int32 __cdecl cluster_get_first_noncollideable_object_and_payload(int32* datum_index, s_cluster_reference cluster_reference, s_object_cluster_payload const** payload);
extern int32 __cdecl cluster_get_next_collideable_object(int32* datum_index);
extern int32 __cdecl cluster_get_next_collideable_object_and_payload(int32* datum_index, s_object_cluster_payload const** payload);
extern int32 __cdecl cluster_get_next_noncollideable_object_and_payload(int32* datum_index, s_object_cluster_payload const** payload);
...
extern int32 __cdecl object_count(int32 type_flags, uint8 header_mask);
...
extern void __cdecl object_detach_from_node(int32 object_index, real_matrix4x3 const* node);
...
extern bool __cdecl object_force_inside_bsp(int32 object_index, real_point3d const* position, int32 ignore_object_index);
extern void __cdecl object_freeze_node_orientations(int32 object_index, bool a2);
extern bool __cdecl object_function_get_function_value(int32 object_index, s_object_function_definition const* function, int32 object_definition_index, real32* out_function_magnitude, bool* deterministic);
...
extern void __cdecl object_get_closest_point_and_normal(int32 object_index, real_point3d const* origin, real_point3d* closest_point, real_vector3d* normal);
...
extern bool __cdecl object_is_hidden_internal(object_header_datum const* object_header, object_datum const* object);
...
extern void __cdecl object_move_position(int32 object_index, real_point3d const* position, real_vector3d const* forward, real_vector3d const* up, s_location const* location);
...
extern void __cdecl object_place(int32 object_index, s_scenario_object const* scenario_object);
extern void __cdecl object_placement_data_copy_change_colors(object_placement_data* data, int32 object_index);
extern void __cdecl object_placement_data_new(object_placement_data* data, int32 definition_index, int32 owner_object_index, s_damage_owner const* damage_owner);
...
extern void __cdecl object_reconnect_to_map(int32 object_index, bool a2, s_location const* location);
...
extern bool __cdecl object_set_base_change_color_by_index(int32 object_index, int32 color_index, real_rgb_color const* color);
...
extern void __cdecl object_set_damage_owner(int32 object_index, s_damage_owner const* damage_owner, bool a3);
extern void __cdecl object_set_desired_velocities(int32 object_index, real_vector3d const* transitional_velocity, real_vector3d const* angular_velocity, bool a4);
...
extern bool __cdecl object_set_position_internal(int32 object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location, bool compute_node_matrices, bool set_havok_object_position, bool in_editor, bool disconnected);
extern void __cdecl object_set_requires_motion(int32 object_index);
extern void __cdecl object_set_velocities(int32 object_index, real_vector3d const* linear_velocity, real_vector3d const* angular_velocity);
extern void __cdecl object_set_position(int32 object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location);
extern void __cdecl object_set_position_direct(int32 object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location, bool in_editor);
extern void __cdecl object_set_position_in_editor(int32 object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location, bool at_rest);
extern void __cdecl object_set_position_in_sandbox_editor(int32 object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location);
extern void* __cdecl object_try_and_get_and_verify_type(int32 object_index, uint32 object_type_mask);
...
extern int32 __cdecl objects_in_sphere(uint32 class_flags, uint32 type_flags, s_location const* location, real_point3d const* center, real32 radius, int32* object_indices, int32 maximum_count);
...
extern void __cdecl objects_update_header_callback(int32 object_index, uint32 datum_handle);
...
extern void object_debug_teleport(int32 object_index, real_point3d const* position);
extern void object_render_debug_internal(int32 object_index);
extern char const* object_describe(int32 object_index);
