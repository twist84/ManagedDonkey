...
extern long __cdecl find_first_predicted_object_recursive(long object_index);
...
extern long __cdecl object_accepted_local_physics_object_get(long object_index);
extern void __cdecl object_activate(long object_index);
extern void __cdecl object_adjust_garbage_timer(long object_index, long time);
extern bool __cdecl object_can_be_melee_instant_killed(long object_index);
extern bool __cdecl object_can_interpolate(long object_index);
extern void __cdecl object_choose_variant(long object_index, long name);
...
//extern void __cdecl object_deactivate(long object_index);
//extern void __cdecl object_deactivate(long object_index, bool a2);
extern bool __cdecl object_definition_predict_low(long object_definition_index);
extern void __cdecl object_delete(long object_index);
extern void __cdecl object_delete_all_multiplayer_cinematic_objects();
extern void __cdecl object_delete_attachments(long object_index);
...
extern void __cdecl object_get_velocities(long object_index, real_vector3d* linear_velocity, real_vector3d* angular_velocity);
extern real_matrix4x3* __cdecl object_get_world_matrix(long object_index, real_matrix4x3* matrix);
extern real_matrix4x3* __cdecl object_get_world_matrix_interpolated(long object_index, real_matrix4x3* out_matrix);
extern bool __cdecl object_has_animation_manager(long object_index);
extern bool __cdecl object_has_multiplayer_properties(long object_index);
extern bool __cdecl object_header_block_allocate(long object_index, short block_reference_offset, short size, short alignment_bits);
extern void __cdecl object_header_delete(long object_index);
extern long __cdecl object_header_new(short size);
extern long __cdecl object_index_from_name_index(short name_index);
extern long __cdecl object_index_from_scenario_object_index(e_object_type object_type, long object_index);
extern bool __cdecl object_is_at_rest(long object_index);
extern bool __cdecl object_is_being_deleted(long object_index);
extern bool __cdecl object_is_connected_to_map(long object_index);
extern bool __cdecl object_is_hidden(long object_index);
extern bool __cdecl object_is_hidden_internal(object_header_datum const* object_header, object_datum const* object);
extern bool __cdecl object_is_hidden_non_recursive(long object_index);
extern bool __cdecl object_is_multiplayer_cinematic_object(long object_index);
extern bool __cdecl object_is_or_contains_player(long object_index);
extern bool __cdecl object_is_running_sync_action(long object_index);
extern bool __cdecl object_is_vehicle(long object_index);
extern long __cdecl object_list_children_by_definition(long object_index, long definition_index);
extern bool __cdecl object_load_scenario_placement_matrices(long object_index);
extern long __cdecl object_local_physics_object_get(long object_index);
extern long __cdecl object_lookup_variant_index_from_name(long object_index, long name);
extern void __cdecl object_make_noise(long object_index, long sound_type, long ai_sound_volume);
...
extern void __cdecl object_move_position(long object_index, real_point3d const* position, real_vector3d const* forward, real_vector3d const* up, s_location const* location);
...
extern void __cdecl object_prepare_axis_vectors(long object_index, real_vector3d* forward, real_vector3d* up);
...
extern void __cdecl object_set_desired_velocities(long object_index, real_vector3d const* transitional_velocity, real_vector3d const* angular_velocity, bool a4);
...
extern bool __cdecl object_set_position_internal(long object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location, bool compute_node_matrices, bool set_havok_object_position, bool in_editor, bool disconnected);
extern void __cdecl object_set_requires_motion(long object_index);
extern void __cdecl object_set_velocities(long object_index, real_vector3d const* linear_velocity, real_vector3d const* angular_velocity);
extern void __cdecl object_set_position(long object_index, real_point3d const* desired_position, real_vector3d const* desired_forward, real_vector3d const* desired_up, s_location const* location);
