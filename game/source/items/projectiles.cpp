...
//.text:00B77650 ; 
//.text:00B77670 ; 
//.text:00B77680 ; void __cdecl projectile_accelerate(int32, real_vector3d const*, real_vector3d const*)
//.text:00B779B0 ; void __cdecl projectile_adjust_for_angular_velocity_change(int32)
//.text:00B77B30 ; bool __cdecl projectile_aim(int32, real_point3d const*, real_point3d const*, bool, real32*, real32*, real32*, real32*, bool, real_vector3d*, real32*, real32*, real32*, bool*)
//.text:00B77C00 ; bool __cdecl projectile_aim_ballistic(real32, real32, real_point3d const*, real_point3d const*, real32*, real32*, real32*, bool, real_vector3d*, real32*, real32*, real32*, real32*, real32*)
//.text:00B78170 ; bool __cdecl projectile_aim_linear(real32, real_point3d const*, real_point3d const*, real_vector3d*, real32*, real32*, real32*)
//.text:00B782A0 ; void __cdecl projectile_apply_detonation_damage(int32, real_point3d const*, real_vector3d const*, real_vector3d const*, real32, s_damage_owner const*, int32, s_location*, int16, bool, bool, bool, int32, e_predictability)
//.text:00B78430 ; void __cdecl projectile_apply_detonation_damage_locally(int32, real_point3d const*, real_vector3d const*, real32, int32, s_location*, bool, e_predictability)
//.text:00B78500 ; void __cdecl projectile_attach(int32, int32, int16, real_point3d const*, s_location const*)
...
//.text:00B7AD50 ; void __cdecl projectile_collision_build_fat_test_points(real_point3d const*, real_point3d const*, real32, int32, real_point3d*, real_point3d*)
//.text:00B7B130 ; bool __cdecl projectile_collision_test_line(int32, real_point3d const*, collision_result*)
...
//.text:00B7B700 ; bool __cdecl projectile_test_water(int32, real_point3d const*)
...
//.text:00B7C370 ; void __cdecl projectile_detonate_effects_and_damage(int32, real_point3d const*, real_vector3d const*, s_effect_vector const*, real32, int32, c_flags<e_simulation_projectile_effect_flag, uint8, 6>, c_global_material_type, real_vector3d const*, s_location*, bool, bool, int32, e_predictability)
//.text:00B7C4D0 ; void __cdecl projectile_detonate_effects_and_damage_shared(int32, real_point3d const*, real_vector3d const*, real_vector3d const*, s_effect_vector const*, real32, s_damage_owner const*, int32, s_location*, int16, c_flags<e_simulation_projectile_effect_flag, uint8, 6>, c_global_material_type, bool, bool, bool, int32, e_predictability)
//.text:00B7C5A0 ; void __cdecl projectile_detonate_external(int32)
//.text:00B7C5C0 ; void __cdecl projectile_detonation_effect(int32, real_point3d const*, real_vector3d const*, real_vector3d const*, s_damage_owner const*, s_damage_reporting_info const&, bool, bool, s_location const*, c_global_material_type, s_effect_vector const*)
...
//.text:00B7CC20 ; void __cdecl projectile_get_effects_by_projectile(int32, real_point3d const*, projectile_definition const*, e_effect_type, c_global_material_type, bool, s_material_effects_result*)
...
//.text:00B7D530 ; real_vector3d const* __cdecl projectile_hit_normal_get(int32, real_vector3d*)
//.text:00B7D5C0 ; void __cdecl projectile_impact_detonation_effect(int32, real32, real32, real_vector3d const*, real_point3d const*, real_vector3d const*, c_global_material_type, bool, int32, int32, bool, bool)
//.text:00B7D7F0 ; void __cdecl projectile_initial_update(int32, bool, uint16, bool*, uint16*)
//.text:00B7DBD0 ; void __cdecl projectile_kill_tracer(int32)
//.text:00B7DC00 ; void __cdecl projectile_make_tracer(int32)
//.text:00B7DC30 ; void __cdecl projectile_material_detonation_effect(int32, real_point3d const*, real_vector3d const*, s_damage_owner const*, c_global_material_type, real_vector3d const*, s_location const*)
//.text:00B7DDB0 ; bool __cdecl projectile_new(int32, object_placement_data*, bool*)
//.text:00B7E160 ; void __cdecl projectile_orient_brute_grenade(int32, real_point3d const*, real_plane3d const*, int32, int32, int32, uint32)
//.text:00B7E3B0 ; void __cdecl projectile_set_action(int32, int16)
//.text:00B7E3F0 ; void __cdecl projectile_set_as_boarding(int32)
//.text:00B7E430 ; void __cdecl projectile_set_targeting_data(int32, s_projectile_targeting_data const*)
//.text:00B7E470 ; void __cdecl projectile_sound_detonation_effect(int32, real_point3d const*, real_vector3d const*)
