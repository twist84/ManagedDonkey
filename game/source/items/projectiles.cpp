...
//.text:00B77650 ; 
//.text:00B77670 ; 
//.text:00B77680 ; void __cdecl projectile_accelerate(long, vector3d const*, vector3d const*)
//.text:00B779B0 ; void __cdecl projectile_adjust_for_angular_velocity_change(long)
//.text:00B77B30 ; bool __cdecl projectile_aim(long, real_point3d const*, real_point3d const*, bool, real*, real*, real*, real*, bool, vector3d*, real*, real*, real*, bool*)
//.text:00B77C00 ; bool __cdecl projectile_aim_ballistic(real, real, real_point3d const*, real_point3d const*, real*, real*, real*, bool, vector3d*, real*, real*, real*, real*, real*)
//.text:00B78170 ; bool __cdecl projectile_aim_linear(real, real_point3d const*, real_point3d const*, vector3d*, real*, real*, real*)
//.text:00B782A0 ; void __cdecl projectile_apply_detonation_damage(long, real_point3d const*, vector3d const*, vector3d const*, real, s_damage_owner const*, long, s_location*, short, bool, bool, bool, long, e_predictability)
//.text:00B78430 ; 
...
//.text:00B79140 ; bool __cdecl projectile_collision(long, collision_result*, real_point3d*, vector3d*, vector3d*, real, long, bool*)
//.text:00B7AD50 ; 
...
//.text:00B7B640 ; 
//.text:00B7B700 ; bool __cdecl projectile_test_water(long, union real_point3d const*)
...
//.text:00B7C370 ; void __cdecl projectile_detonate_effects_and_damage(long, real_point3d const*, vector3d const*, s_effect_vector const*, real, long, c_flags<e_simulation_projectile_effect_flag, byte, 6>, c_global_material_type, vector3d const*, s_location*, bool, bool, long, e_predictability)
//.text:00B7C4D0 ; void __cdecl projectile_detonate_effects_and_damage_shared(long, real_point3d const*, vector3d const*, vector3d const*, s_effect_vector const*, real, s_damage_owner const*, long, s_location*, short, c_flags<e_simulation_projectile_effect_flag, byte, 6>, c_global_material_type, bool, bool, bool, long, e_predictability)
//.text:00B7C5A0 ; void __cdecl projectile_detonate_external(long)
//.text:00B7C5C0 ; void __cdecl projectile_detonation_effect(long, real_point3d const*, vector3d const*, vector3d const*, s_damage_owner const*, s_damage_reporting_info const&, bool, bool, s_location const*, c_global_material_type, s_effect_vector const*)
//.text:00B7C750 ; 
...
//.text:00B7D530 ; vector3d const* __cdecl projectile_hit_normal_get(long, vector3d*)
//.text:00B7D5C0 ; void __cdecl projectile_impact_detonation_effect(long, real, real, vector3d const*, real_point3d const*, vector3d const*, c_global_material_type, bool, long, long, bool, bool)
...
//.text:00B7DC00 ; 
//.text:00B7DC30 ; void __cdecl projectile_material_detonation_effect(long, real_point3d const*, vector3d const*, s_damage_owner const*, c_global_material_type, vector3d const*, s_location const*)
...
//.text:00B7E800 ; void __cdecl projectile_translate_with_initial_test_against_object_type(long, vector3d*)
