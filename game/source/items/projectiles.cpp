...
//.text:00B77B30 ; bool __cdecl projectile_aim(long, real_point3d const*, real_point3d const*, bool, real32*, real32*, real32*, real32*, bool, real_vector3d*, real32*, real32*, real32*, bool*)
...
//.text:00B782A0 ; void __cdecl projectile_apply_detonation_damage(long, real_point3d const*, real_vector3d const*, real_vector3d const*, real32, s_damage_owner const*, long, s_location*, short, bool, bool, bool, long, e_predictability)
//.text:00B78430 ; void __cdecl projectile_apply_detonation_damage_locally(long, real_point3d const*, real_vector3d const*, real32, long, s_location*, bool, e_predictability)
...
//.text:00B79140 ; bool __cdecl projectile_collision(long, collision_result*, real_point3d*, real_vector3d*, real_vector3d*, real32, long, bool*)
//.text:00B7AD50 ; void __cdecl projectile_collision_build_fat_test_points(real_point3d const*, real_point3d const*, real32, long, real_point3d*, real_point3d*)
//.text:00B7B130 ; bool __cdecl projectile_collision_test_line(long, real_point3d const*, collision_result*)
//.text:00B7B460 ; bool __cdecl projectile_compute_function_value(long, long, long, real32*, bool*, bool*)
...
//.text:00B7BA40 ; real32 __cdecl projectile_definition_get_autoaim_max_lead_time(long)
//.text:00B7BA60 ; real32 __cdecl projectile_definition_get_velocity_multiplier(long, bool)
//.text:00B7BB40 ; void __cdecl projectile_detonate(long, long, e_projectile_action_reasons)
//.text:00B7C370 ; void __cdecl projectile_detonate_effects_and_damage(long, real_point3d const*, real_vector3d const*, s_effect_vector const*, real32, long, c_flags<e_simulation_projectile_effect_flag, uint8, 6>, c_global_material_type, real_vector3d const*, s_location*, bool, bool, long, e_predictability)
//.text:00B7C4D0 ; void __cdecl projectile_detonate_effects_and_damage_shared(long, real_point3d const*, real_vector3d const*, real_vector3d const*, s_effect_vector const*, real32, s_damage_owner const*, long, s_location*, short, c_flags<e_simulation_projectile_effect_flag, uint8, 6>, c_global_material_type, bool, bool, bool, long, e_predictability)
...
//.text:00B7C7D0 ; bool __cdecl projectile_estimate_collision_along_arc(long, real32, long, s_collision_test_flags, bool, real_point3d*, real32*)
//.text:00B7CAA0 ; real32 __cdecl projectile_estimate_time_to_target(long, real32, bool)
//.text:00B7CB00 ; real32 __cdecl projectile_get_ballistic_acceleration(long)
...
//.text:00B7D5C0 ; void __cdecl projectile_impact_detonation_effect(long, real32, real32, real_vector3d const*, real_point3d const*, real_vector3d const*, c_global_material_type, bool, long, long, bool, bool)
//.text:00B7D7F0 ; void __cdecl projectile_initial_update(long, bool, uint16, bool*, uint16*)
...
//.text:00B7E160 ; void __cdecl projectile_orient_brute_grenade(long, real_point3d const*, real_plane3d const*, long, long, long, uint32)
