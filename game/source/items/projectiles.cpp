...
//.text:00B7C370 ; void __cdecl projectile_detonate_effects_and_damage(int32, real_point3d const*, real_vector3d const*, s_effect_vector const*, real32, int32, c_flags<e_simulation_projectile_effect_flag, uns8, 6>, c_global_material_type, real_vector3d const*, s_location*, bool, bool, int32, e_predictability)
//.text:00B7C4D0 ; void __cdecl projectile_detonate_effects_and_damage_shared(int32, real_point3d const*, real_vector3d const*, real_vector3d const*, s_effect_vector const*, real32, s_damage_owner const*, int32, s_location*, int16, c_flags<e_simulation_projectile_effect_flag, uns8, 6>, c_global_material_type, bool, bool, bool, int32, e_predictability)
...
//.text:00B7E160 ; void __cdecl projectile_orient_brute_grenade(int32, real_point3d const*, real_plane3d const*, int32, int32, int32, uns32)
