...
extern void __cdecl cinematic_dispose_from_old_structure_bsp(dword deactivating_structure_bsp_mask);
...
extern void __cdecl cinematic_initialize_for_new_structure_bsp(dword activating_structure_bsp_mask);
extern void __cdecl cinematic_prepare_for_new_zone_set(dword old_active_structure_bsp_mask, dword new_active_structure_bsp_mask);
