...
void __cdecl effects_initialize_for_new_non_bsp_zone_set(s_game_non_bsp_zone_set const* non_bsp_zone_set)
{
	INVOKE(0x00530210, effects_initialize_for_new_non_bsp_zone_set, non_bsp_zone_set);
}

void __cdecl effects_dispose_from_old_non_bsp_zone_set(s_game_non_bsp_zone_set const* non_bsp_zone_set)
{
	INVOKE(0x00530220, effects_dispose_from_old_non_bsp_zone_set, non_bsp_zone_set);
}
...
void __cdecl effects_dispose_from_old_structure_bsp(dword structure_bsp_mask)
{
	INVOKE(0x005BBFD0, effects_dispose_from_old_structure_bsp, structure_bsp_mask);
}
...
void __cdecl effects_initialize_for_new_structure_bsp(dword structure_bsp_mask)
{
	INVOKE(0x005BCA80, effects_initialize_for_new_structure_bsp, structure_bsp_mask);
}

void __cdecl effects_prepare_for_non_bsp_zone_set_switch(s_game_non_bsp_zone_set const* a1, s_game_non_bsp_zone_set const* a2, c_scenario_resource_registry* resource_registry)
{
	INVOKE(0x005BCE50, effects_prepare_for_non_bsp_zone_set_switch, a1, a2, resource_registry);
}
