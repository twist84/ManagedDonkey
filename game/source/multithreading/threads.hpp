...
extern void __cdecl register_thread(void* handle, long thread_index, uint32 thread_id, void* user_data);
...
extern bool __cdecl wait_for_thread_to_exit(long thread_index, uint32 timeout_in_milliseconds);
