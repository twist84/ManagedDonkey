...
extern int32 __cdecl cache_file_get_failed_count(char const* map_path);
...
extern bool __cdecl cache_files_copy_map(char const* scenario_path, int32 load_action);
extern bool __cdecl cache_files_copy_map_start_only(char const* scenario_path, int32 load_action);
...
extern int32 __cdecl cache_files_get_file_status(char const* scenario_path);
...
extern bool __cdecl cached_map_file_dependencies_loaded(s_cache_file_header const* header, uns32* shared_files_flags);
