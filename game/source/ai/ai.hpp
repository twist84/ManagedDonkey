...
COMPILE_ASSERT(sizeof(ai_mission_critical_actor) == 0x10);
...
COMPILE_ASSERT(sizeof(ai_globals_type) == 0x688);
COMPILE_ASSERT(0x000 == OFFSETOF(ai_globals_type, ai_active));
COMPILE_ASSERT(0x001 == OFFSETOF(ai_globals_type, ai_initialized_for_map));
COMPILE_ASSERT(0x002 == OFFSETOF(ai_globals_type, ai_has_control_data));
COMPILE_ASSERT(0x003 == OFFSETOF(ai_globals_type, selected_firing_position_this_tick));
COMPILE_ASSERT(0x004 == OFFSETOF(ai_globals_type, built_path_this_tick));
COMPILE_ASSERT(0x005 == OFFSETOF(ai_globals_type, fast_and_dumb_ai));
COMPILE_ASSERT(0x006 == OFFSETOF(ai_globals_type, last_highest_pathfinding_service_timer));
COMPILE_ASSERT(0x008 == OFFSETOF(ai_globals_type, current_highest_pathfinding_service_timer));
COMPILE_ASSERT(0x00A == OFFSETOF(ai_globals_type, pathfinding_time_given_this_frame));
COMPILE_ASSERT(0x00C == OFFSETOF(ai_globals_type, last_highest_perception_service_timer));
COMPILE_ASSERT(0x00E == OFFSETOF(ai_globals_type, current_highest_perception_service_timer));
COMPILE_ASSERT(0x010 == OFFSETOF(ai_globals_type, perception_time_given_this_frame));
COMPILE_ASSERT(0x012 == OFFSETOF(ai_globals_type, current_objective_index));
COMPILE_ASSERT(0x014 == OFFSETOF(ai_globals_type, first_squadless_actor_index));
COMPILE_ASSERT(0x018 == OFFSETOF(ai_globals_type, highest_clump_refresh_weight));
COMPILE_ASSERT(0x01C == OFFSETOF(ai_globals_type, major_upgrade_error));
COMPILE_ASSERT(0x020 == OFFSETOF(ai_globals_type, dialogue_enabled));
COMPILE_ASSERT(0x022 == OFFSETOF(ai_globals_type, dialogue_suppression_ticks));
COMPILE_ASSERT(0x024 == OFFSETOF(ai_globals_type, ai_player_dialogue_enable));
COMPILE_ASSERT(0x028 == OFFSETOF(ai_globals_type, last_chatter_time));
COMPILE_ASSERT(0x030 == OFFSETOF(ai_globals_type, last_talk_time));
COMPILE_ASSERT(0x038 == OFFSETOF(ai_globals_type, last_shout_time));
COMPILE_ASSERT(0x040 == OFFSETOF(ai_globals_type, spatial_effects_first_index));
COMPILE_ASSERT(0x042 == OFFSETOF(ai_globals_type, spatial_effects_last_index));
COMPILE_ASSERT(0x044 == OFFSETOF(ai_globals_type, spatial_effects));
COMPILE_ASSERT(0x3C4 == OFFSETOF(ai_globals_type, grenades_enabled));
COMPILE_ASSERT(0x3C8 == OFFSETOF(ai_globals_type, infection_allowed_time));
COMPILE_ASSERT(0x3CC == OFFSETOF(ai_globals_type, mounted_weapon_unit_count));
COMPILE_ASSERT(0x3D0 == OFFSETOF(ai_globals_type, mounted_weapon_unit_indices));
COMPILE_ASSERT(0x3F0 == OFFSETOF(ai_globals_type, last_squad_placed));
COMPILE_ASSERT(0x3F4 == OFFSETOF(ai_globals_type, perception_refresh_last_index));
COMPILE_ASSERT(0x3F6 == OFFSETOF(ai_globals_type, active_ai_count));
COMPILE_ASSERT(0x3F8 == OFFSETOF(ai_globals_type, __unknown3F8));
COMPILE_ASSERT(0x3FC == OFFSETOF(ai_globals_type, last_player_shooting_time));
COMPILE_ASSERT(0x400 == OFFSETOF(ai_globals_type, last_prop_track_cleanup_time));
COMPILE_ASSERT(0x404 == OFFSETOF(ai_globals_type, mission_critical_units));
COMPILE_ASSERT(0x484 == OFFSETOF(ai_globals_type, cached_cluster_ref));
COMPILE_ASSERT(0x488 == OFFSETOF(ai_globals_type, cached_pas));
