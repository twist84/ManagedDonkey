...
//.text:014BD1D0 ; real __cdecl path_attractor_weight(path_state const*, c_ai_point3d const*, c_ai_point3d const*, real*)
...
//.text:014BD670 ; void __cdecl path_input_new(path_input*, real, bool, long, real)
//.text:014BD6C0 ; void __cdecl path_input_set_attractor(path_input*, real_point3d const*, real, real, long, real, bool)
//.text:014BD710 ; void __cdecl path_input_set_search_bounds(path_input*, real)
...
//.text:014BF7A0 ; real __cdecl path_state_unit_distance(path_state*, c_ai_point3d const*, c_sector_ref, long)
...
//.text:014BF990 ; public: void __cdecl c_path_destination::set(c_ai_point3d const*, c_sector_ref const*, real)
