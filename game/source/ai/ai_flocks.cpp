...
//.text:014C1DB0 ; void __cdecl boundary_force_bounding_volume(const s_flock_instance*, real_point3d*, real32*, real_vector3d*, bool, bool*)
...
//.text:014C22C0 ; int16 __cdecl flock_choose_source(flock_datum*, const s_flock_instance*)
