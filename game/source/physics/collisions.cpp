...
short __cdecl collision_move_pill(s_collision_test_flags flags, real_point3d const* old_position, real_vector3d const* old_velocity, real height, real radius, long first_ignore_object_index, long second_ignore_object_index, real_point3d* new_position, real_vector3d* new_velocity, short maximum_collision_count, collision_plane* collisions)
{
...
short __cdecl collision_move_sphere(s_collision_test_flags flags, real_point3d const* old_position, real_vector3d const* old_velocity, real radius, long first_ignore_object_index, long second_ignore_object_index, real_point3d* new_position, real_vector3d* new_velocity, short maximum_collision_count, collision_plane* collisions)
{
...
//.text:006D6D90 ; bool __cdecl collision_test_rectangle3d(real_rectangle3d const*, real_point3d const*, real_vector3d const*, real, real*, real*)
...
//.text:006D8440 ; bool __cdecl instanced_geometry_test_vector(long, long, c_flags<e_collision_test_flag, dword, k_collision_test_flags_count>, real_point3d const*, real_vector3d const*, collision_result*)
//.text:006D8580 ; bool __cdecl instanced_geometry_test_vector_internal(structure_context const*, long, c_flags<e_collision_test_flag, dword, k_collision_test_flags_count>, dword, real_point3d const*, real_vector3d const*, collision_result*)
//.text:006D89E0 ; 
