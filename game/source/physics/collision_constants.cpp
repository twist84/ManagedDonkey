...
REFERENCE_DECLARE(0x0471A840, s_collision_test_flags, stru_471A840); // #TODO: find my name
...
REFERENCE_DECLARE(0x0471A860, s_collision_test_flags, stru_471A860); // #TODO: find my name
...
REFERENCE_DECLARE(0x0471A878, s_collision_test_flags, stru_471A878); // #TODO: find my name
REFERENCE_DECLARE(0x0471A880, s_collision_test_flags, stru_471A880); // #TODO: find my name
REFERENCE_DECLARE(0x0471A888, s_collision_test_flags, stru_471A888); // #TODO: find my name
REFERENCE_DECLARE(0x0471A890, s_collision_test_flags, _collision_test_pathfinding_flags);
REFERENCE_DECLARE(0x0471A898, s_collision_test_flags, stru_471A898); // #TODO: find my name
...
REFERENCE_DECLARE(0x0471A8B0, s_collision_test_flags, stru_471A8B0); // #TODO: find my name
REFERENCE_DECLARE(0x0471A8B8, s_collision_test_flags, stru_471A8B8); // #TODO: find my name
