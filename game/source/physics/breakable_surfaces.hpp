...
extern void __cdecl breakable_surfaces_dispose_from_old_structure_bsp(dword deactivating_structure_bsp_mask);
extern void __cdecl breakable_surfaces_initialize();
extern void __cdecl breakable_surfaces_initialize_for_new_map();
extern void __cdecl breakable_surfaces_initialize_for_new_structure_bsp(dword activating_structure_bsp_mask);
