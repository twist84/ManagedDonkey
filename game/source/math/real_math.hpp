...
extern real __cdecl magnitude_squared2d(real_vector2d const* v);
extern real __cdecl magnitude_squared3d(real_vector3d const* v);
extern real __cdecl magnitude2d(real_vector2d const* v);
extern real __cdecl magnitude3d(real_vector3d const* v);
extern real_vector3d* __cdecl negate_vector3d(real_vector3d const* a, real_vector3d* result);
extern real __cdecl normalize3d(real_vector3d* v);
...
extern real_point3d* __cdecl point_from_line3d(real_point3d const* p, real_vector3d const* v, real t, real_point3d* result);
extern real_point2d* __cdecl point_from_line2d(real_point2d const* p, real_vector2d const* v, real t, real_point2d* result);
extern bool __cdecl point_in_sphere(real_point3d const* point, real_point3d const* center, real radius);
extern bool __cdecl point_intersects_rectangle2d(real_point2d const* p, real_rectangle2d const* bounds);
extern real_vector2d* __cdecl rotate_vector2d(real_vector2d const* v, real sine, real cosine, real_vector2d* result);
extern real_vector3d* __cdecl scale_vector3d(real_vector3d const* a, real c, real_vector3d* result);
extern real_point2d* __cdecl set_real_point2d(real_point2d* p, real x, real y);
extern real_point3d* __cdecl set_real_point3d(real_point3d* p, real x, real y, real z);
extern real_rectangle2d* __cdecl set_real_rectangle2d(real_rectangle2d* bounds, real x0, real x1, real y0, real y1);
extern real_rectangle3d* __cdecl set_real_rectangle3d(real_rectangle3d* bounds, real x0, real x1, real y0, real y1, real z0, real z1);
...
extern real __cdecl square_root(real x);
extern real __cdecl triple_product3d(real_vector3d const* a, real_vector3d const* b, real_vector3d const* n);
