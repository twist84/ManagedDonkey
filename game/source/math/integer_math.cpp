...
rectangle2d* __cdecl adjust_rectangle2d(const rectangle2d* bounds, const rectangle2d* source, rectangle2d* destination, int16 mode)
{
	return INVOKE(0x0052DE10, adjust_rectangle2d, bounds, source, destination, mode);
}

bool __cdecl bit_vector_and(int32 count, const uns32* v0, const uns32* v1, uns32* result)
{
	return INVOKE(0x0052DF40, bit_vector_and, count, v0, v1, result);
}

int32 __cdecl bit_vector_count_bits(const uns32* vector, int32 count)
{
	return INVOKE(0x0052DFA0, bit_vector_count_bits, vector, count);
}

int32 __cdecl bit_vector_highest_bit_set(const uns32* vector, int32 count)
{
	return INVOKE(0x0052E1E0, bit_vector_highest_bit_set, vector, count);
}

int32 __cdecl bit_vector_lowest_bit_set(const uns32* vector, int32 count)
{
	return INVOKE(0x0052E280, bit_vector_lowest_bit_set, vector, count);
}

void __cdecl bit_vector_not(int32 count, const uns32* vector, uns32* result)
{
	INVOKE(0x0052E330, bit_vector_not, count, vector, result);
}

void __cdecl bit_vector_not_and(int32 count, const uns32* v0, const uns32* v1, uns32* result)
{
	INVOKE(0x0052E360, bit_vector_not_and, count, v0, v1, result);
}

void __cdecl bit_vector_or(int32 count, const uns32* v0, const uns32* v1, uns32* result)
{
...
rectangle2d* __cdecl center_rectangle2d(rectangle2d* a, const rectangle2d* b)
{
	return INVOKE(0x0052E4F0, center_rectangle2d, a, b);
}

rectangle2d* __cdecl center_rectangle2d_horizontal(rectangle2d* a, const rectangle2d* b)
{
	return INVOKE(0x0052E570, center_rectangle2d_horizontal, a, b);
}

rectangle2d* __cdecl center_rectangle2d_vertical(rectangle2d* a, const rectangle2d* b)
{
	return INVOKE(0x0052E5C0, center_rectangle2d_vertical, a, b);
}

bool __cdecl equal_point2d(const point2d* p1, const point2d* p2)
{
...
bool __cdecl equal_rectangle2d(const rectangle2d* r1, const rectangle2d* r2)
{
...
bool __cdecl intersect_rectangles2d(const rectangle2d* r1, const rectangle2d* r2, rectangle2d* intersection)
{
...
bool __cdecl point2d_in_rectangle2d(const rectangle2d* rectangle, const point2d* point)
{
...
int16 rectangle2d_height(const rectangle2d* rectangle)
{
...
rectangle2d* __cdecl rectangle2d_hull_from_rectangles2d(const rectangle2d* r1, const rectangle2d* r2, rectangle2d* hull)
{
	return INVOKE(0x0052E970, rectangle2d_hull_from_rectangles2d, r1, r2, hull);
}

int16 rectangle2d_width(const rectangle2d* rectangle)
{
...
rectangle2d* __cdecl scale_rectangle2d(const rectangle2d* bounds, const rectangle2d* source, rectangle2d* destination, int16 scale)
{
