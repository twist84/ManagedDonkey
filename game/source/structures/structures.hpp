...
extern void __cdecl structures_dispose_from_old_structure_bsp(dword structure_bsp_mask);
extern void __cdecl structures_initialize();
extern void __cdecl structures_initialize_for_new_map();
extern void __cdecl structures_initialize_for_new_structure_bsp(dword structure_bsp_mask);
