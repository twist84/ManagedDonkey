...
void __cdecl structure_seams_initialize_for_new_structure_bsp(long scenario_index, s_structure_seams const* structure_seams, uint32 activating_structure_bsp_mask)
{
