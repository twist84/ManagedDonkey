...
c_model_animation_graph const* __cdecl c_model_animation_graph::get(int32 definition_index)
{
...
//.text:00784BF0 ; public: s_additional_node_data const* __cdecl c_model_animation_graph::get_additional_node_data(int32) const
...
//.text:00785260 ; public: s_dialogue_event const* __cdecl c_model_animation::get_dialogue_event(int32) const
//.text:00785270 ; public: s_effect_event const* __cdecl c_model_animation::get_effect_event(int32) const
//.text:00785290 ; public: animation_graph_effect_reference const* __cdecl c_model_animation_graph::get_effect_reference(int32) const
//.text:007852C0 ; public: s_foot_tracking_member const* __cdecl c_model_animation_graph::get_foot_tracking_member(int32) const
...
c_model_animation_graph const* __cdecl c_model_animation_graph::get_from_object_definition(int32 object_definition_index)
{
...
//.text:00785440 ; public: c_model_animation_graph const* __cdecl c_model_animation_graph::get_inherited_graph(int32) const
//.text:00785480 ; public: int32 __cdecl c_model_animation_graph::get_inherited_graph_count() const
//.text:00785490 ; public: s_frame_event const* __cdecl c_model_animation::get_keyframe_event(int32) const
...
//.text:007854F0 ; public: c_model_animation const* __cdecl c_model_animation_graph::get_local_animation(int32) const
...
//.text:007855B0 ; public: animation_aiming_screen_bounds const* __cdecl c_model_animation_graph::get_local_blend_screen_bounds(int32) const
//.text:007855D0 ; private: c_model_animation_tag_resource_group const* __cdecl c_model_animation_graph::get_local_resource_group(int32) const
//.text:00785600 ; private: c_model_animation_tag_resource_member const* __cdecl c_model_animation_graph::get_local_resource_group_member(int32, int32) const
...
//.text:00785900 ; 
//.text:00785910 ; 
//.text:00785930 ; public: animation_graph_sound_reference const* __cdecl c_model_animation_graph::get_sound_reference(int32) const
//.text:00785960 ; 
//.text:00785970 ; 
//.text:00785980 ; 
//.text:00785990 ; 
