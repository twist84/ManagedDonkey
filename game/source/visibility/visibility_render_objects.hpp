...
extern int32 __cdecl visibility_render_objects_compute_level_of_detail(int32 object_index, int32 player_window_index, const s_model_level_of_detail* level_of_detail_definition, real32 lod_distance, int8 last_lod);
...
extern bool __cdecl visibility_render_objects_geometry_in_cache(int32 render_model_index, int32 region_count, const int8* region_permutation_indices, int8* last_region_permutation_indices, int32 level_of_detail, bool desired_geometry, uns8* mesh_indices, bool* using_old_permutation);
