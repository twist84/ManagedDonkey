...
extern bool __cdecl visibility_render_objects_find_geometry(int32 object_index, int32 render_model_index, int32 player_window_index, int16* desired_level_of_detail, int8 last_level_of_detail, uint8* mesh_indices, int32* region_count, bool* using_old_permutation, uint16* a9);
extern int16 __cdecl visibility_render_objects_find_lightmap_object_index(int32 object_index);
extern bool __cdecl visibility_render_objects_geometry_in_cache(int32 render_model_index, int32 region_count, int8 const* region_permutation_indices, int8* last_region_permutation_indices, int32 level_of_detail, bool desired_geometry, uint8* mesh_indices, bool* using_old_permutation);
