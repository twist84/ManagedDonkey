...
void __cdecl portal_activation_dispose_from_old_structure_bsp(uns32 deactivating_structure_bsp_mask)
{
...
void __cdecl portal_activation_initialize_for_new_structure_bsp(uns32 activating_structure_bsp_mask)
{
