...
bool __cdecl visibility_render_objects_geometry_in_cache(long render_model_index, long region_count, char const* region_permutation_indices, char* last_region_permutation_indices, long level_of_detail, bool desired_geometry, byte* mesh_indices, bool* using_old_permutation)
{
...
bool __cdecl visibility_render_objects_get_model_info(long object_index, real lod_distance, real screen_pixels, long player_window_index, s_render_object_info* info)
{
