...
int32 __cdecl visibility_render_objects_compute_level_of_detail(int32 object_index, int32 player_window_index, s_model_level_of_detail const* level_of_detail_definition, real32 lod_distance, char last_lod)
{
...
bool __cdecl visibility_render_objects_find_geometry(int32 object_index, int32 render_model_index, int32 player_window_index, int16* desired_level_of_detail, char last_level_of_detail, uint8* mesh_indices, int32* region_count, bool* using_old_permutation, uint16* a9)
{
...
bool __cdecl visibility_render_objects_geometry_in_cache(int32 render_model_index, int32 region_count, char const* region_permutation_indices, char* last_region_permutation_indices, int32 level_of_detail, bool desired_geometry, uint8* mesh_indices, bool* using_old_permutation)
{
...
char __cdecl visibility_render_objects_get_last_level_of_detail_rendered(int32 object_index, int32 player_window_index)
{
...
void __cdecl visibility_render_objects_set_last_level_of_detail_rendered(int32 object_index, int32 player_window_index, char lod)
{
