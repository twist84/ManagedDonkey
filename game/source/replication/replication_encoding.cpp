...
bool __cdecl player_motion_compare(const s_player_motion* player_motion_a, s_player_motion* player_motion_b)
{
...
void __cdecl player_motion_encode(c_bitstream* packet, const s_player_motion* player_motion)
{
...
bool __cdecl player_motion_valid(const s_player_motion* player_motion)
{
    return INVOKE(0x004AA760, player_motion_valid, player_motion);
}

bool __cdecl player_prediction_compare_identical(const s_player_prediction* player_prediction_a, const s_player_prediction* player_prediction_b)
{
...
void __cdecl player_prediction_encode(c_bitstream* packet, const s_player_prediction* player_prediction, bool replicated)
{
...
bool __cdecl player_prediction_valid(const s_player_prediction* player_prediction)
{
...
bool __cdecl predicted_aim_assist_compare(const s_player_predicted_aim_assist* aim_assist_a, s_player_predicted_aim_assist* aim_assist_b)
{
...
//void __cdecl predicted_aim_assist_encode(c_bitstream* packet, const s_player_predicted_aim_assist* aim_assist, bool a3, e_aim_assist_encoding_precision encoding_precision)
void __cdecl predicted_aim_assist_encode(c_bitstream* packet, const s_player_predicted_aim_assist* aim_assist, bool a3, int32 encoding_precision)
{
