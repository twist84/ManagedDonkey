...
s_data_array* __cdecl runtime_state_data_new(char const* name, long maximum_count, long size)
{
...
void const* __cdecl runtime_state_get_buffer_address(long* buffer_size)
{
...
void* __cdecl runtime_state_malloc_aligned(char const* name, char const* type, long size, long alignment_bits)
{
	...
	long true_size = size + pointer_difference(allocation_end, allocation_end_aligned);
	...
	g_runtime_state_globals.size_checksum = crc_checksum_buffer(g_runtime_state_globals.size_checksum, (uint8*)&true_size, sizeof(true_size));

	return allocation_end_aligned;
}

void* __cdecl runtime_state_malloc(char const* name, char const* type, long size)
{
...
void* __cdecl runtime_state_allocate_buffer(long size)
{
