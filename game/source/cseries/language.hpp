...
extern const char* __cdecl get_current_language_suffix(bool english_is_empty);
extern const char* get_language_display_name(e_language language);
extern e_language get_language_from_display_name_slow(const char* display_name);
extern const char* __cdecl get_language_iso_639_1_name(e_language language);
extern const char* __cdecl get_language_suffix(e_language language, bool english_is_empty);
...
extern void __cdecl set_current_language_from_display_name_slow(const char* display_name);