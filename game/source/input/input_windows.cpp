...
byte __cdecl input_key_frames_down(e_input_key_code key_code, e_input_type input_type)
{
...
word __cdecl input_key_msec_down(e_input_key_code key_code, e_input_type input_type)
{
