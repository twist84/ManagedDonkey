...
//.text:00A6D890 ; void __cdecl rasterizer_memory_GPU_frontend_allocate_from_cost(const s_rasterizer_memory_cost* cost)
//.text:00A6D8C0 ; real32 __cdecl rasterizer_memory_GPU_frontend_remaining()
//.text:00A6D8D0 ; void __cdecl rasterizer_memory_add_cost(const s_rasterizer_memory_cost* cost, s_rasterizer_memory_cost* result)
//.text:00A6D900 ; void __cdecl rasterizer_memory_add_cost_difference(const s_rasterizer_memory_cost* higher_cost, const s_rasterizer_memory_cost* lower_cost, s_rasterizer_memory_cost* result)
...
//.text:00A6DA50 ; bool __cdecl rasterizer_memory_compare_costs(const s_rasterizer_memory_cost* cost, const s_rasterizer_memory_cost* target_cost, bool a3)
