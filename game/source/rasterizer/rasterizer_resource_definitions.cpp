...
IDirect3DVertexDeclaration9* c_vertex_declaration_table::get_d3d_vertex_declaration_by_entry_point(e_vertex_type base_vertex_type, e_transfer_vector_vertex_types transfer_vertex_type, int32 entry_point)
{
    ...
    {
        return get_d3d_vertex_declaration(base_vertex_type, _lighting_vertex_type_unknown2, _transfer_vertex_none);
    }
    case _entry_point_static_per_vertex:
    {
        return get_d3d_vertex_declaration(base_vertex_type, _lighting_vertex_type_unknown3, _transfer_vertex_none);
    }
    ...
    {
        return get_d3d_vertex_declaration(base_vertex_type, _lighting_vertex_type_unknown1, _transfer_vertex_none);
    }
    }
