...
void c_game_engine_juggernaut_variant::set_score_to_win_round(short score_to_win_round)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid score_to_win_round setting '%d' outside range '[%d, %d]'!", score_to_win_round, 0, 500);
...
void c_game_engine_juggernaut_variant::set_initial_juggernaut(e_juggernaut_initial_juggernaut_settings initial_juggernaut)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid initial_juggernaut setting '%d' outside range '[0, %d)'!", initial_juggernaut, k_juggernaut_next_juggernaut_settings);
...
void c_game_engine_juggernaut_variant::set_next_juggernaut(e_juggernaut_next_juggernaut_settings next_juggernaut)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid next_juggernaut setting '%d' outside range '[0, %d)'!", next_juggernaut, k_juggernaut_next_juggernaut_settings);
...
void c_game_engine_juggernaut_variant::set_zone_movement(e_juggernaut_zone_movement_settings zone_movement)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid zone_movement setting '%d' outside range '[0, %d)'!", zone_movement, k_number_of_juggernaut_zone_movement_settings);
...
void c_game_engine_juggernaut_variant::set_zone_order(e_juggernaut_zone_order_settings zone_order)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid zone_order setting '%d' outside range '[0, %d)'!", zone_order, k_juggernaut_zone_order_settings);
...
void c_game_engine_juggernaut_variant::set_kill_points(char kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid kill_points setting '%d' outside range '[%d, %d]'!", kill_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_juggernaut_kill_points(char juggernaut_kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid juggernaut_kill_points setting '%d' outside range '[%d, %d]'!", juggernaut_kill_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_kill_as_juggernaut_points(char kill_as_juggernaut_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid kill_as_juggernaut_points setting '%d' outside range '[%d, %d]'!", kill_as_juggernaut_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_destination_arrival_points(char destination_arrival_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid destination_arrival_points setting '%d' outside range '[%d, %d]'!", destination_arrival_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_suicide_points(char suicide_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid suicide_points setting '%d' outside range '[%d, %d]'!", suicide_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_betrayal_points(char betrayal_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid betrayal_points setting '%d' outside range '[%d, %d]'!", betrayal_points, -10, 10);
...
void c_game_engine_juggernaut_variant::set_juggernaut_delay(byte juggernaut_delay)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:juggernaut: invalid juggernaut_delay setting '%d' outside range '[%d, %d]'!", juggernaut_delay, 0, 10);
