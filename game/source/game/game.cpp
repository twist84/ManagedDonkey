...
#if defined(_DEBUG)
#define DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(NAME) .name = #NAME,
#else
#define DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(NAME)
#endif // _DEBUG
...
s_game_system const g_game_systems[]
{
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(screenshots_loader)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00680DF0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00680DE0, dispose),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(transport)
	...
	},
	{
		...
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EF10, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EDA0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EF20, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EDB0, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EF70, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2EE00, dispose_from_old_structure_bsp),
	},
	{
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(network)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(input_abstraction)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(game_time)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(profiler)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530230, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530240, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530250, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530260, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(game_allegiance)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00670220, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0066FFC0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00670290, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0066FFD0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(players)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005422C0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00541AF0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00542340, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00541B30, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00542460, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00541B70, dispose_from_old_structure_bsp),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(player_control)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005D2EE0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005D0A40, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005D3120, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005D0A50, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(player_training)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00689B90, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00689A20, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00689BF0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00689A30, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(game_engine)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00550FF0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0054E290, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005511A0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0054E2A0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(simulation)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(scenario)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004EA340, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004E9F90, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004EA350, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004E9FA0, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004EA370, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x004E9FB0, dispose_from_old_structure_bsp),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(physics_constants)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(collision_debug)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(objects)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(object_early_movers)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B98A20, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B989E0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B98A90, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B98A00, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(object_scripting)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B95CD0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B959F0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B95D30, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B95A10, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(object_scheduler)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B99E90, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B99E60, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B99EF0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B99E80, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(object_activation_regions)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B9A5D0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B9A590, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B9A610, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00B9A5B0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(scenario_kill_trigger_volumes)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(scenario_sky_objects)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678EF0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678ED0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678F00, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678EE0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(scenario_soft_ceilings)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00674C50, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00674960, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00674CB0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00674970, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(campaign_metagame)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00607C80, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00606F90, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00607CE0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00606FB0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(autosave_queue)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067BEC0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067BDA0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067BED0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067BDB0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(saved_game_files)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00526840, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00525DA0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00526890, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00525DB0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(survival_mode)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00689140, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00688DE0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006891F0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00688E10, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(c_rasterizer)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(render)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A29900, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A296F0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A29970, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A29730, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A29980, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A29750, dispose_from_old_structure_bsp),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(structures)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006783E0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006783B0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006783F0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006783C0, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678400, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006783D0, dispose_from_old_structure_bsp),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(breakable_surfaces)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056B6E0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056ADC0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056B770, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056ADF0, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056B800, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0056AE10, dispose_from_old_structure_bsp),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(director)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(render_texture_camera)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3ACD0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3AB90, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3AD30, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3ABA0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(render_hud_camera)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2DB50, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2D880, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2DBB0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2D890, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(s_scripted_exposure)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2AA90, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2A7E0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2AAF0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A2A7F0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(s_render_game_state)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3E750, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3E6D0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3E7B0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A3E6E0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(c_decal_system)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006931F0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00691B00, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006936C0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00691CD0, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005302D0, prepare_for_new_zone_set),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00693740, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00691D70, dispose_from_old_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0068FBB0, change_pvs),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006941B0, prepare_for_non_bsp_zone_set_switch),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005302E0, initialize_for_new_non_bsp_zone_set),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005302F0, dispose_from_old_non_bsp_zone_set),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(effects)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BC740, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BBE70, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BC990, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BBF10, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530200, prepare_for_new_zone_set),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BCA80, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BBFD0, dispose_from_old_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x005BCE50, prepare_for_non_bsp_zone_set_switch),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530210, initialize_for_new_non_bsp_zone_set),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530220, dispose_from_old_non_bsp_zone_set),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(point_physics)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00695C90, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00695C70, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00695CA0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00695C80, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(c_atmosphere_fog_interface)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00673820, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530180, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00673880, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530170, dispose_from_old_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006738F0, initialize_for_new_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00530190, dispose_from_old_structure_bsp),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00672230, change_pvs),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(screen_effect)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00683010, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00682EF0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00683040, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00682F20, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(sound_classes)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006612C0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00661290, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00661330, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006612B0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(sound)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(game_sound_deterministic)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0068CBE0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0068CA10, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0068CD40, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0068CA40, dispose_from_old_map),
	},
	{
	...
	},
	{
		...
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678630, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678600, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678690, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00678610, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(rumble)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00615700, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006156E0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00615760, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006156F0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(player_effect)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00684A00, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00684650, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00684A60, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00684660, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(user_interface)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A84580, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A84270, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A84650, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A842A0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(interface)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AAE610, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADC50, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AAE620, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADC60, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(chud)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A89790, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A88D70, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A897A0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00A88D80, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(overhead_map)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(cheats)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(screenshots_uploader)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00619680, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00619610, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00619690, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00619620, dispose_from_old_map),
	},
	{
	...
	},
	{
		...
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00679330, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006791C0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00679400, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006791E0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(recorded_animations)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00681F10, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00681EE0, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00681F50, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00681EF0, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(debug_menu)
	...
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(error_report_render)
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADB80, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADB50, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADB90, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00AADB60, dispose_from_old_map),
	},
	{
	...
	},
	{
		...
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067A4E0, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067A370, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067A510, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x0067A390, dispose_from_old_map),
	},
	{
	...
	},
	{
		...
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00688880, initialize),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00688600, dispose),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x006888E0, initialize_for_new_map),
		DECLARE_GAME_SYSTEM_MEMBER_ADDRESS(0x00688620, dispose_from_old_map),
	},
	{
		DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY(game_save)
...
#undef DECLARE_GAME_SYSTEM_NAME_DEBUG_ONLY
