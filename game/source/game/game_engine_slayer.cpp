...
void c_game_engine_slayer_variant::set_score_to_win(short score_to_win)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid score_to_win setting '%d' outside range '[%d, %d]'!", score_to_win, -1, 520);
...
void c_game_engine_slayer_variant::set_kill_points(char kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid kill_points setting '%d' outside range '[%d, %d]'!", kill_points, -10, 10);
...
void c_game_engine_slayer_variant::set_assist_points(char assist_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid assist_points setting '%d' outside range '[%d, %d]'!", assist_points, -10, 10);
...
void c_game_engine_slayer_variant::set_death_points(char death_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid death_points setting '%d' outside range '[%d, %d]'!", death_points, -10, 10);
...
void c_game_engine_slayer_variant::set_suicide_points(char suicide_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid suicide_points setting '%d' outside range '[%d, %d]'!", suicide_points, -10, 10);
...
void c_game_engine_slayer_variant::set_betrayal_points(char betrayal_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid betrayal_points setting '%d' outside range '[%d, %d]'!", betrayal_points, -10, 10);
...
void c_game_engine_slayer_variant::set_leader_killed_points(char leader_killed_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid leader_killed_points setting '%d' outside range '[%d, %d]'!", leader_killed_points, -10, 10);
...
void c_game_engine_slayer_variant::set_elimination_points(char elimination_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid elimination_points setting '%d' outside range '[%d, %d]'!", elimination_points, -10, 10);
...
void c_game_engine_slayer_variant::set_assassination_points(char assassination_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid assassination_points setting '%d' outside range '[%d, %d]'!", assassination_points, -10, 10);
...
void c_game_engine_slayer_variant::set_headshot_points(char headshot_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid headshot_points setting '%d' outside range '[%d, %d]'!", headshot_points, -10, 10);
...
void c_game_engine_slayer_variant::set_melee_points(char melee_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid melee_points setting '%d' outside range '[%d, %d]'!", melee_points, -10, 10);
...
void c_game_engine_slayer_variant::set_sticky_points(char sticky_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid sticky_points setting '%d' outside range '[%d, %d]'!", sticky_points, -10, 10);
...
void c_game_engine_slayer_variant::set_splatter_points(char splatter_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid splatter_points setting '%d' outside range '[%d, %d]'!", splatter_points, -10, 10);
...
void c_game_engine_slayer_variant::set_killing_spree_points(char killing_spree_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:slayer: invalid killing_spree_points setting '%d' outside range '[%d, %d]'!", killing_spree_points, -10, 10);
