...
void c_game_engine_vip_variant::set_score_to_win_round(short score_to_win_round)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid score_to_win_round setting '%d' outside range '[%d, %d]'!", score_to_win_round, 0, 500);
...
void c_game_engine_vip_variant::set_kill_points(char kill_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid kill_points setting '%d' outside range '[%d, %d]'!", kill_points, -10, 10);
...
void c_game_engine_vip_variant::set_takedown_points(char takedown_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid takedown_points setting '%d' outside range '[%d, %d]'!", takedown_points, -10, 10);
...
void c_game_engine_vip_variant::set_kill_as_vip_points(char kill_as_vip_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid kill_as_vip_points setting '%d' outside range '[%d, %d]'!", kill_as_vip_points, -10, 10);
...
void c_game_engine_vip_variant::set_vip_death_points(char vip_death_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid vip_death_points setting '%d' outside range '[%d, %d]'!", vip_death_points, -10, 10);
...
void c_game_engine_vip_variant::set_destination_arrival_points(char destination_arrival_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid destination_arrival_points setting '%d' outside range '[%d, %d]'!", destination_arrival_points, -10, 10);
...
void c_game_engine_vip_variant::set_suicide_points(char suicide_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid suicide_points setting '%d' outside range '[%d, %d]'!", suicide_points, -10, 10);
...
void c_game_engine_vip_variant::set_betrayal_points(char betrayal_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid betrayal_points setting '%d' outside range '[%d, %d]'!", betrayal_points, -10, 10);
...
void c_game_engine_vip_variant::set_vip_suicide_points(char vip_suicide_points)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid vip_suicide_points setting '%d' outside range '[%d, %d]'!", vip_suicide_points, -10, 10);
...
void c_game_engine_vip_variant::set_vip_selection(e_vip_vip_selection_settings vip_selection)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid vip_selection setting '%d' outside range '[0, %d)'!", vip_selection, k_vip_vip_selection_settings);
...
void c_game_engine_vip_variant::set_zone_movement(e_vip_zone_movement_settings zone_movement)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid zone_movement setting '%d' outside range '[0, %d)'!", zone_movement, k_number_of_vip_zone_movement_settings);
...
void c_game_engine_vip_variant::set_zone_order(e_vip_zone_order_settings zone_order)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid zone_order setting '%d' outside range '[0, %d)'!", zone_order, k_vip_zone_order_settings);
...
void c_game_engine_vip_variant::set_influence_radius(short influence_radius)
{
	...
	{
		WARNING_EVENT("game_engine:vip: invalid influence_radius setting '%d' outside range '[%d, %d]'!", influence_radius, 0, 50);
