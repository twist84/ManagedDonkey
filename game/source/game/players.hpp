...
extern void __cdecl players_dispose_from_old_structure_bsp(dword structure_bsp_mask);
...
extern void __cdecl players_initialize_for_new_structure_bsp(dword structure_bsp_mask);
