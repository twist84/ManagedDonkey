...
extern void __cdecl player_set_configuration(int32 player_index, const s_player_configuration* configuration_data);
...
extern void __cdecl player_validate_configuration(int32 player_index, s_player_configuration* configuration_data);
