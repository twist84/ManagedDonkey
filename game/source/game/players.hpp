...
extern void __cdecl player_positions_dispose_from_old_structure_bsp(dword old_structure_bsp_mask);
extern void __cdecl player_positions_initialize();
extern void __cdecl player_positions_initialize_for_new_map();
extern void __cdecl player_positions_initialize_for_new_structure_bsp(dword new_structure_bsp_mask);
...
extern void __cdecl players_initialize_for_new_structure_bsp(dword new_structure_bsp_mask);
