...
void c_game_engine_oddball_variant::set_score_to_win(short score_to_win)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid score_to_win setting '%d' outside range '[%d, %d]'!", score_to_win, -1, 1000);
...
void c_game_engine_oddball_variant::set_carrying_points(char carrying_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid carrying_points setting '%d' outside range '[%d, %d]'!", carrying_points, -10, 10);
...
void c_game_engine_oddball_variant::set_kill_points(char kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid kill_points setting '%d' outside range '[%d, %d]'!", kill_points, -10, 10);
...
void c_game_engine_oddball_variant::set_ball_kill_points(char ball_kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid ball_kill_points setting '%d' outside range '[%d, %d]'!", ball_kill_points, -10, 10);
...
void c_game_engine_oddball_variant::set_carrier_kill_points(char carrier_kill_points)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid carrier_kill_points setting '%d' outside range '[%d, %d]'!", carrier_kill_points, -10, 10);
...
void c_game_engine_oddball_variant::set_ball_count(char ball_count)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid ball_count setting '%d' outside range '[%d, %d]'!", ball_count, 1, 3);
...
void c_game_engine_oddball_variant::set_ball_spawn_delay(short ball_spawn_delay)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid ball_spawn_delay setting '%d' outside range '[%d, %d]'!", ball_spawn_delay, 0, 120);
...
void c_game_engine_oddball_variant::set_ball_inactive_respawn_delay(short ball_inactive_respawn_delay)
{
	...
	{
		GENERATE_EVENT(_event_warning, "game_engine:oddball: invalid ball_inactive_respawn_delay setting '%d' outside range '[%d, %d]'!", ball_inactive_respawn_delay, 0, 120);
