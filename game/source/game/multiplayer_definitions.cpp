...
int32 __cdecl multiplayer_universal_data_get_random_weapon_definition_index()
{
...
int32 __cdecl multiplayer_universal_data_get_vehicle_selection_definition_index(int32 name)
{
	return INVOKE(0x0069CF70, multiplayer_universal_data_get_vehicle_selection_definition_index, name);
}

int16 __cdecl multiplayer_universal_data_get_vehicle_set_absolute_index_from_string_id(int32 name)
{
	return INVOKE(0x0069CFF0, multiplayer_universal_data_get_vehicle_set_absolute_index_from_string_id, name);
}

int32 __cdecl multiplayer_universal_data_get_vehicle_set_name_from_absolute_index(int16 absolute_index)
{
	return INVOKE(0x0069D070, multiplayer_universal_data_get_vehicle_set_name_from_absolute_index, absolute_index);
}

int32 __cdecl multiplayer_universal_data_get_weapon_selection_definition_index(int32 name)
{
	return INVOKE(0x0069D0E0, multiplayer_universal_data_get_weapon_selection_definition_index, name);
}

int16 __cdecl multiplayer_universal_data_get_weapon_set_absolute_index_from_string_id(int32 name)
{
	return INVOKE(0x0069D160, multiplayer_universal_data_get_weapon_set_absolute_index_from_string_id, name);
}

int32 __cdecl multiplayer_universal_data_get_weapon_set_name_from_absolute_index(int16 absolute_index)
{
