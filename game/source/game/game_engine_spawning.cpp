...
//.text:006D0C50 ; real32 __cdecl game_engine_calculate_cumulative_spawn_location_weight(real_point3d const* point, bool a2, bool a3, real32 a4, real32 a5, s_dynamic_spawn_influencer_collection const* spawn_influencer_collection);
//.text:006D0D50 ; s_netgame_goal_spawn_influence const* __cdecl game_engine_ctf_flag_away_spawn_influence_try_and_get();
//.text:006D0DB0 ; s_player_spawn_influence const* __cdecl game_engine_dead_teammate_spawn_influence_try_and_get(real32* duration);
...
//.text:006D1290 ; s_projectile_spawn_influence const* __cdecl game_engine_projectile_spawn_influence_try_and_get(int32 object_index, real_vector3d* translational_velocity);
...
//.text:006D14D0 ; void __cdecl game_engine_spawn_influence_add_netgame_goal_object_influence(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
...
//.text:006D1B20 ; bool __cdecl game_engine_spawn_influencer_test_point(real_point3d const* point, s_dynamic_spawn_influencer const* influencer, real32* out_percentage_of_nominal_weight);
//.text:006D1D70 ; return true;
//.text:006D1D80 ; void __cdecl game_engine_spawn_influencers_add_ally_bias(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
//.text:006D1E60 ; void __cdecl game_engine_spawn_influencers_add_dead_teammate_influence(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
//.text:006D1FF0 ; void __cdecl game_engine_spawn_influencers_add_enemy_bias_influence(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
//.text:006D2110 ; void __cdecl game_engine_spawn_influencers_add_enemy_forbid_influence(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
...
//.text:006D2460 ; void __cdecl game_engine_spawn_influencers_add_weapon_influence(int32 player_index, player_datum const* player, s_dynamic_spawn_influencer_collection* spawn_influencer_collection);
...
//.text:006D2A00 ; s_vehicle_spawn_influence const* __cdecl game_engine_vehicle_spawn_influence_try_and_get(int32 object_index, real_vector3d* translational_velocity, real32* bounding_sphere_radius);
//.text:006D2B80 ; s_netgame_goal_spawn_influence const* __cdecl game_engine_vip_spawn_influence_try_and_get();
//.text:006D2BE0 ; s_weapon_spawn_influence const* __cdecl game_engine_weapon_spawn_influence_try_and_get(int32 object_index);
