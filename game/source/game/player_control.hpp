...
extern void __cdecl player_control_get_aiming_vector(long user_index, vector3d* aiming_vector);
...
extern void __cdecl player_control_set_facing(long input_user_index, vector3d const* facing);
