...
void __cdecl game_grief_record_reprieve()
{
	...
	//c_console::write_line("betrayal forgiveness granted");
}
...
void __cdecl game_grief_record_betrayal(long player_index)
{
	...
	//c_console::write_line("local absolute player %d controller %d betrayed (count %d, %s)!",
	//	player_index,
	//	controller,
	//	betrayal_count,
	//	is_griefer ? "GRIEFER" : "not yet griefer");
...
void __cdecl game_grief_record_ejection(long player_index)
{
	...
	//c_console::write_line("ejection recorded for player %d", player_index);
	//
...
void __cdecl game_grief_update()
{
	...
	//	c_console::write_line("ejection count decremented!");
	//
	...
	//	c_console::write_line("forgiveness grace period expired");
	//
	//	game_grief_globals.reprieve_time = 0;
	//}
	//
