...
extern void __cdecl build_multiplayer_string(int32 player_index, const wchar_t* formatted_string, const s_game_engine_event_data* event_data, int32 buffer_size, wchar_t* dest_ptr);
