...
struct s_player_mapping_globals
{
	...
	c_static_array<long, k_number_of_input_users> output_user_player_mapping;
	c_static_array<long, k_number_of_input_users> output_user_unit_mapping;
...
extern void __cdecl player_mapping_attach_output_user(long output_user_index, long player_index);
...
extern long __cdecl player_mapping_get_next_output_user(long player_index, long output_user_index);
...
extern long __cdecl player_mapping_get_player_by_output_user(long output_user_index);
...
extern long __cdecl player_mapping_next_active_output_user(long output_user_index);
extern long __cdecl player_mapping_output_user_active_count();
extern bool __cdecl player_mapping_output_user_is_active(long output_user_index);
extern void __cdecl player_mapping_output_user_set_unit(long output_user_index, long unit_index);
