...
extern bool __cdecl cheat_drop_effect(tag group_tag, char const* effect_name, int32 effect_index, real_point3d* position, real_vector3d* forward);
extern bool __cdecl cheat_drop_object(tag group_tag, char const* tag_name, tag expected_group_tag, int32 object_definition_index, int32 variant_name, int32 shader, real_point3d const* position, real_vector3d const* forward, s_model_customization_region_permutation const* permutations, int32 permutation_count);
extern int32 __cdecl cheat_drop_tag(tag group_tag, char const* tag_name, char const* variant_name, s_model_customization_region_permutation const* permutations, int32 permutation_count);
extern void __cdecl cheat_drop_tag_in_main_event_loop(int32 tag_index, int32 variant_name, s_model_customization_region_permutation const* permutations, int32 permutation_count);
...
extern void __cdecl cheat_drop_tag_name_with_variant_and_permutations(char const* tag_name, char const* variant_name, s_model_customization_region_permutation const* permutations, int32 permutation_count);
...
extern int32 __cdecl cheat_get_region_and_permutation_array_from_string(char const* permutation_info, s_model_customization_region_permutation* permutations, int32 maximum_permutations);
extern int32 __cdecl cheat_get_tag_definition(tag group_tag, char const* tag_name);
...
extern bool __cdecl cheats_process_gamepad(int32 controller_index, s_game_input_state const* input_state);
