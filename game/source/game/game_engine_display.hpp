...
extern real32 __cdecl game_engine_get_user_fade_to_black_amount(long user_index);
extern real32 __cdecl game_engine_hud_get_fade(long user_index);
extern void __cdecl game_engine_render(long user_index);
extern void __cdecl game_engine_render_debug(long user_index);
extern void __cdecl game_engine_render_fade_to_black(long user_index);
extern void __cdecl game_engine_render_watermarks();
extern bool __cdecl game_engine_suppress_render_scene(long user_index);
