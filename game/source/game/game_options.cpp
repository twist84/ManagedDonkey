...
void c_game_variant::copy_from_unsafe(c_game_variant const* other)
{
	INVOKE_CLASS_MEMBER(0x005730F0, c_game_variant::copy_from_unsafe, other);
}

long __cdecl c_game_variant::get_variant_size_for_game_engine_index(e_game_engine_type game_engine_index) const
{
	//return INVOKE_CLASS_MEMBER(0x0057A2E0, c_game_variant::get_variant_size_for_game_engine_index, game_engine_index);
...
bool __cdecl c_game_variant::is_equal_to(c_game_variant const* other) const
{
...
void __cdecl c_game_variant::recreate_variant_vtable_for_game_engine_index(e_game_engine_type game_engine_index)
{
...
void __cdecl c_game_variant::set_game_engine_index(e_game_engine_type game_engine_index)
{
	INVOKE_CLASS_MEMBER(0x0057AA70, c_game_variant::set_game_engine_index, game_engine_index);
}
...
bool __cdecl c_game_variant::get_game_engine_setting(e_game_variant_parameter parameter, e_text_value_pair_parameter_type parameter_type, long* out_value) const
{
	return INVOKE_CLASS_MEMBER(0x00574530, c_game_variant::get_game_engine_setting, parameter, parameter_type, out_value);
}

bool __cdecl c_game_variant::set_game_engine_setting(e_game_variant_parameter parameter, e_text_value_pair_parameter_type parameter_type, long value)
{
