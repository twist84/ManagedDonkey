...
void c_game_engine_infection_variant::set_safe_havens(e_infection_safe_havens_settings safe_havens)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid safe_havens setting '%d' outside range '[0, %d)'!", safe_havens, k_infection_safe_havens_settings);
...
void c_game_engine_infection_variant::set_next_zombie(e_infection_next_zombie_settings next_zombie)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid next_zombie setting '%d' outside range '[0, %d)'!", next_zombie, k_infection_next_zombie_settings);
...
void c_game_engine_infection_variant::set_initial_zombie_count(e_infection_initial_zombie_count_settings initial_zombie_count)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid initial_zombie_count setting '%d' outside range '[0, %d)'!", initial_zombie_count, k_infection_initial_zombie_count_settings);
...
void c_game_engine_infection_variant::set_safe_haven_movement_time(short safe_haven_movement_time)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid safe_haven_movement_time setting '%d' outside range '[%d, %d]'!", safe_haven_movement_time, 0, 120);
...
void c_game_engine_infection_variant::set_zombie_kill_points(char zombie_kill_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid zombie_kill_points setting '%d' outside range '[%d, %d]'!", zombie_kill_points, -10, 10);
...
void c_game_engine_infection_variant::set_infection_points(char infection_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid infection_points setting '%d' outside range '[%d, %d]'!", infection_points, -10, 10);
...
void c_game_engine_infection_variant::set_safe_haven_arrival_points(char safe_haven_arrival_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid safe_haven_arrival_points setting '%d' outside range '[%d, %d]'!", safe_haven_arrival_points, -10, 10);
...
void c_game_engine_infection_variant::set_suicide_points(char suicide_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid suicide_points setting '%d' outside range '[%d, %d]'!", suicide_points, -10, 10);
...
void c_game_engine_infection_variant::set_betrayal_points(char betrayal_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid betrayal_points setting '%d' outside range '[%d, %d]'!", betrayal_points, -10, 10);
...
void c_game_engine_infection_variant::set_last_man_bonus_points(char last_man_bonus_points)
{
	...
	{
		WARNING_EVENT("game_engine:infection: invalid last_man_bonus_points setting '%d' outside range '[%d, %d]'!", last_man_bonus_points, -10, 10);
