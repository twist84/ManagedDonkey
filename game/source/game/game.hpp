...
extern void __cdecl game_initialize_for_new_structure_bsp(dword structure_bsp_mask);
...
extern void __cdecl game_prepare_for_non_bsp_zone_set_switch(s_game_non_bsp_zone_set const* a1, s_game_non_bsp_zone_set const* a2, c_scenario_resource_registry* resource_registry);
extern void __cdecl game_prepare_to_switch_structure_bsp(dword a1, dword a2);
