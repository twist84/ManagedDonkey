...
extern void __cdecl game_dispose_from_old_structure_bsp(dword old_structure_bsp_mask);
...
extern void __cdecl game_initialize_for_new_structure_bsp(dword new_structure_bsp_mask);
