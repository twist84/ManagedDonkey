...
void c_game_engine_sandbox_variant::set_edit_mode(e_sandbox_edit_mode_settings edit_mode)
{
	...
	{
		WARNING_EVENT("game_engine:sandbox: invalid edit_mode setting '%d' outside range '[0, %d)'!", edit_mode, k_sandbox_edit_mode_settings);
...
void c_game_engine_sandbox_variant::set_respawn_time(short respawn_time)
{
	...
	{
		WARNING_EVENT("game_engine:sandbox: invalid respawn_time setting '%d' outside range '[%d, %d]'!", respawn_time, _sandbox_respawn_time_instant, _sandbox_respawn_time_60_seconds);
