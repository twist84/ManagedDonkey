...
//.text:00480200 ; c_managed_session_overlapped_task* __cdecl c_managed_session_overlapped_task::c_managed_session_overlapped_task(char const*, int32);
...
void __cdecl add_to_player_list(s_online_session_player* players, int32 player_count, uns64 const* xuids, bool const* xuids_left_game, int32 xuid_count)
{
...
void __cdecl managed_session_add_players(int32 index, uns64 const* xuids, bool const* xuids_left_game, int32 xuid_count)
{
...
bool __cdecl managed_session_build_add_xuid_list(int32 index)
{
	return INVOKE(0x00480790, managed_session_build_add_xuid_list, index);
}

bool __cdecl managed_session_build_removal_xuid_list(int32 index)
{
...
void __cdecl managed_session_cancel_new_host(int32 index)
{
	INVOKE(0x00480950, managed_session_cancel_new_host, index);
}

void __cdecl managed_session_commit_new_host(int32 index)
{
	INVOKE(0x00480D10, managed_session_commit_new_host, index);
}

bool __cdecl managed_session_compare_id(int32 index, s_transport_secure_identifier const* session_id)
{
	return INVOKE(0x00480DD0, managed_session_compare_id, index, session_id);
}

void __cdecl managed_session_completely_reset_session_on_error(int32 index)
{
	INVOKE(0x00480E60, managed_session_completely_reset_session_on_error, index);
}

void __cdecl managed_session_connect_client_to_new_host(int32 index, s_transport_session_description const* session_description, e_transport_platform platform)
{
...
//int32 __cdecl managed_session_create_host(e_network_session_class session_class, c_flags<e_managed_session_creation_flags, uns8, 4> creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_online_context const* creation_contexts, int32 creation_context_count)
int32 __cdecl managed_session_create_host(e_network_session_class session_class, uns8 creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_online_context const* creation_contexts, int32 creation_context_count)
{
...
void __cdecl managed_session_create_host_migration_internal(int32 index, s_online_managed_session* managed_session)
{
	INVOKE(0x00481370, managed_session_create_host_migration_internal, index, managed_session);
}

void __cdecl managed_session_create_session_internal(int32 index, s_online_managed_session* managed_session)
{
	INVOKE(0x00481550, managed_session_create_session_internal, index, managed_session);
}

void __cdecl managed_session_creation_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00481930, managed_session_creation_complete, index, succeeded, a3);
}

void __cdecl managed_session_delete(int32 index)
{
	INVOKE(0x00481A80, managed_session_delete, index);
}

void __cdecl managed_session_delete_host_migration_internal(int32 index, s_online_managed_session* managed_session)
{
	INVOKE(0x00481B10, managed_session_delete_host_migration_internal, index, managed_session);
}

void __cdecl managed_session_delete_session_internal(int32 index, s_online_managed_session* managed_session)
{
	INVOKE(0x00481C10, managed_session_delete_session_internal, index, managed_session);
}

void __cdecl managed_session_deletion_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00481D30, managed_session_deletion_complete, index, succeeded, a3);
}

void __cdecl managed_session_free(int32 index)
{
	INVOKE(0x00481DE0, managed_session_free, index);
}

void __cdecl managed_session_game_end(int32 index)
{
	INVOKE(0x00481E10, managed_session_game_end, index);
}

void __cdecl managed_session_game_end_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00481EB0, managed_session_game_end_complete, index, succeeded, a3);
}

void __cdecl managed_session_game_start(int32 index)
{
	INVOKE(0x00481F10, managed_session_game_start, index);
}

void __cdecl managed_session_game_start_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00481F80, managed_session_game_start_complete, index, succeeded, a3);
}

s_online_managed_session* __cdecl managed_session_get(int32 index)
{
	return INVOKE(0x00481FE0, managed_session_get, index);
}

bool __cdecl managed_session_get_handle(int32 index, void** handle_out)
{
	return INVOKE(0x00482000, managed_session_get_handle, index, handle_out);
}

bool __cdecl managed_session_get_id(int32 index, s_transport_secure_identifier* session_id)
{
	return INVOKE(0x00482040, managed_session_get_id, index, session_id);
}

char const* __cdecl managed_session_get_id_string(int32 index)
{
...
void __cdecl managed_session_get_new_host_information(int32 index, s_transport_session_description* session_description, e_transport_platform* platform)
{
	INVOKE(0x004820D0, managed_session_get_new_host_information, index, session_description, platform);
}

bool __cdecl managed_session_get_nonce(int32 index, uns64* nonce)
{
	return INVOKE(0x00482140, managed_session_get_nonce, index, nonce);
}

bool __cdecl managed_session_get_security_information(int32 index, bool host_migrating, s_transport_session_description* session_description, e_transport_platform* platform)
{
	return INVOKE(0x00482170, managed_session_get_security_information, index, host_migrating, session_description, platform);
}

//c_flags<e_managed_session_status_flags, uns16, 14> __cdecl managed_session_get_status(int32 index)
uns16 __cdecl managed_session_get_status(int32 index)
{
...
void __cdecl managed_session_host_migration_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00482410, managed_session_host_migration_complete, index, succeeded, a3);
}

bool __cdecl managed_session_is_host(int32 index)
{
	return INVOKE(0x00482500, managed_session_is_host, index);
}

bool __cdecl managed_session_is_live(int32 index)
{
	return INVOKE(0x00482530, managed_session_is_live, index);
}

bool __cdecl managed_session_is_master_session(int32 index)
{
	return INVOKE(0x00482560, managed_session_is_master_session, index);
}

void __cdecl managed_session_mark_session_to_be_created_offline(int32 index)
{
	INVOKE(0x00482590, managed_session_mark_session_to_be_created_offline, index);
}

void __cdecl managed_session_modify_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x004825B0, managed_session_modify_complete, index, succeeded, a3);
}

void __cdecl managed_session_modify_slot_counts(int32 index, int32 private_slot_count, int32 public_slot_count, bool friends_only, bool slots_locked)
{
...
void __cdecl managed_session_players_add_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x00482750, managed_session_players_add_complete, index, succeeded, a3);
}

void __cdecl managed_session_players_remove_complete(int32 index, bool succeeded, uns32 a3)
{
	INVOKE(0x004827F0, managed_session_players_remove_complete, index, succeeded, a3);
}

void __cdecl managed_session_process_pending_operations(int32 index)
{
	INVOKE(0x00482880, managed_session_process_pending_operations, index);
}

void __cdecl managed_session_remove_players(int32 index, uns64 const* xuids, int32 xuid_count)
{
	INVOKE(0x00482D60, managed_session_remove_players, index, xuids, xuid_count);
}

void __cdecl managed_session_reset_players_add_status(int32 index)
{
	INVOKE(0x00482DB0, managed_session_reset_players_add_status, index);
}

void __cdecl managed_session_reset_session(int32 index, bool a2)
{
	INVOKE(0x00482DD0, managed_session_reset_session, index, a2);
}

int32 __cdecl managed_session_retrieve_security_information(transport_address const* usable_address, e_transport_platform platform, s_transport_session_description* session_description, s_transport_secure_address* secure_address)
{
...
void __cdecl managed_session_start_host_migration(int32 index)
{
	INVOKE(0x00482FC0, managed_session_start_host_migration, index);
}

void __cdecl managed_session_successful_creation_complete(int32 index)
{
	INVOKE(0x00483040, managed_session_successful_creation_complete, index);
}

void __cdecl managed_session_successful_delete_complete(int32 index)
{
	INVOKE(0x004831F0, managed_session_successful_delete_complete, index);
}

void __cdecl managed_session_successful_delete_host_migration_complete(int32 index)
{
	INVOKE(0x00483290, managed_session_successful_delete_host_migration_complete, index);
}

void __cdecl managed_session_successful_game_end_complete(int32 index)
{
	INVOKE(0x004832D0, managed_session_successful_game_end_complete, index);
}

void __cdecl managed_session_successful_game_start_complete(int32 index)
{
	INVOKE(0x00483300, managed_session_successful_game_start_complete, index);
}

void __cdecl managed_session_successful_host_migration_creation_complete(int32 index)
{
	INVOKE(0x00483330, managed_session_successful_host_migration_creation_complete, index);
}

void __cdecl managed_session_successful_modify_complete(int32 index)
{
	INVOKE(0x004833F0, managed_session_successful_modify_complete, index);
}

void __cdecl managed_session_successful_players_add_complete(int32 index)
{
	INVOKE(0x00483440, managed_session_successful_players_add_complete, index);
}

void __cdecl managed_session_successful_players_remove_complete(int32 index)
{
	INVOKE(0x004834D0, managed_session_successful_players_remove_complete, index);
}

bool __cdecl managed_session_synchronize_to_player_list(int32 index, c_network_session_membership* session_membership)
{
	return INVOKE(0x00483540, managed_session_synchronize_to_player_list, index, session_membership);
}

void __cdecl managed_session_use_new_host(int32 index)
{
	INVOKE(0x004837D0, managed_session_use_new_host, index);
}

int32 __cdecl managed_session_who_has_this_session_id(s_transport_secure_identifier const* session_id)
{
...
void __cdecl remove_from_player_list(s_online_session_player* players, int32 player_count, uns64 const* xuids, int32 xuid_count)
{
