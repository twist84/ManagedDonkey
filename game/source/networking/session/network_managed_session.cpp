...
void __cdecl add_to_player_list(s_online_session_player* players, int32 player_count, uint64 const* xuids, bool const* xuids_left_game, int32 xuid_count)
{
...
void __cdecl managed_session_add_players(int32 index, uint64 const* xuids, bool const* xuids_left_game, int32 xuid_count)
{
...
int32 __cdecl managed_session_create_client(e_network_session_class session_class, uint8 creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_transport_secure_identifier const* session_id, s_transport_secure_address const* host_address, s_transport_secure_key const* key, s_online_context const* creation_contexts, int32 creation_context_count)
{
...
//int32 __cdecl managed_session_create_host(e_network_session_class session_class, c_flags<e_managed_session_creation_flags, uint8, 4> creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_online_context const* creation_contexts, int32 creation_context_count)
int32 __cdecl managed_session_create_host(e_network_session_class session_class, uint8 creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_online_context const* creation_contexts, int32 creation_context_count)
{
...
void __cdecl managed_session_creation_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_deletion_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_game_end_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_game_start_complete(int32 index, bool succeeded, uint32 a3)
{
...
bool __cdecl managed_session_get_nonce(int32 index, uint64* nonce)
{
...
//c_flags<e_managed_session_status_flags, uint16, 14> __cdecl managed_session_get_status(int32 index)
uint16 __cdecl managed_session_get_status(int32 index)
{
...
void __cdecl managed_session_host_migration_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_modify_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_players_add_complete(int32 index, bool succeeded, uint32 a3)
{
	INVOKE(0x00482750, managed_session_players_add_complete, index, succeeded, a3);
}

void __cdecl managed_session_players_remove_complete(int32 index, bool succeeded, uint32 a3)
{
...
void __cdecl managed_session_remove_players(int32 index, uint64 const* xuids, int32 xuid_count)
{
...
void __cdecl remove_from_player_list(s_online_session_player* players, int32 player_count, uint64 const* xuids, int32 xuid_count)
{
