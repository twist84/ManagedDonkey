...
{
	void __thiscall process_add_players(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session, uint64 const* a4, bool const* a5, bool const* a6, int32 a7);
	void __thiscall process_create(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session, uint16 flags);
	void __thiscall process_delete(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session);
	void __thiscall process_game_end(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session);
	void __thiscall process_modify(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session, s_online_session* desired_session, s_online_session* actual_session);
	void __thiscall process_game_start(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session);
	void __thiscall process_remove_players(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session, uint64 const* a4, bool const* a5, int32 player_count);
	void __thiscall process_session_host_migrate(int32 managed_session_index, void(__cdecl* callback)(int32, bool, uint32), s_online_session* session, bool is_host, s_transport_session_description* host_migration_description);
	...
	void(__cdecl* m_completion_routine)(int32, bool, uint32);
	bool m_result;
...
extern void __cdecl add_to_player_list(s_online_session_player* players, int32 player_count, uint64 const* xuids, bool const* xuids_left_game, int32 xuid_count);
extern void __cdecl managed_session_add_players(int32 index, uint64 const* xuids, bool const* xuids_left_game, int32 xuid_count);
...
extern int32 __cdecl managed_session_create_client(e_network_session_class session_class, uint8 creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_transport_secure_identifier const* session_id, s_transport_secure_address const* host_address, s_transport_secure_key const* key, s_online_context const* creation_contexts, int32 creation_context_count);
extern int32 __cdecl managed_session_create_host(e_network_session_class session_class, uint8 creation_flags, e_transport_platform platform, int32 private_slot_count, int32 public_slot_count, s_online_context const* creation_contexts, int32 creation_context_count);
...
extern void __cdecl managed_session_creation_complete(int32 index, bool succeeded, uint32 a3);
...
extern void __cdecl managed_session_deletion_complete(int32 index, bool succeeded, uint32 a3);
extern void __cdecl managed_session_free(int32 index);
extern void __cdecl managed_session_game_end(int32 index);
extern void __cdecl managed_session_game_end_complete(int32 index, bool succeeded, uint32 a3);
extern void __cdecl managed_session_game_start(int32 index);
extern void __cdecl managed_session_game_start_complete(int32 index, bool succeeded, uint32 a3);
...
extern bool __cdecl managed_session_get_nonce(int32 index, uint64* nonce);
...
extern uint16 __cdecl managed_session_get_status(int32 index);
extern bool __cdecl managed_session_handle_valid(void* handle);
extern void __cdecl managed_session_host_migration_complete(int32 index, bool succeeded, uint32 a3);
...
extern void __cdecl managed_session_modify_complete(int32 index, bool succeeded, uint32 a3);
...
extern void __cdecl managed_session_players_add_complete(int32 index, bool succeeded, uint32 a3);
extern void __cdecl managed_session_players_remove_complete(int32 index, bool succeeded, uint32 a3);
extern void __cdecl managed_session_process_pending_operations(int32 index);
extern void __cdecl managed_session_remove_players(int32 index, uint64 const* xuids, int32 xuid_count);
...
extern void __cdecl remove_from_player_list(s_online_session_player* players, int32 player_count, uint64 const* xuids, int32 xuid_count);
