...
extern int32 __cdecl network_time_difference_msec(uint32 time_a, uint32 time_b);
extern uint32 __cdecl network_time_get();
extern uint32 __cdecl network_time_get_exact();
extern int32 network_time_since(uint32 time);
...
extern bool __cdecl network_session_time_get_id_and_time(int32 session_index, s_transport_secure_identifier* session_id, uint32* time);
