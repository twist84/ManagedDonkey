...
void __cdecl network_message_types_register_out_of_band(c_network_message_type_collection* message_collection)
{
    ...
    message_collection->register_message_type(_network_message_ping, "ping", 0, sizeof(s_network_message_ping), sizeof(s_network_message_ping), c_network_message_ping::encode, c_network_message_ping::decode, nullptr, nullptr);
    message_collection->register_message_type(_network_message_pong, "pong", 0, sizeof(s_network_message_pong), sizeof(s_network_message_pong), c_network_message_pong::encode, c_network_message_pong::decode, nullptr, nullptr);
    message_collection->register_message_type(_network_message_broadcast_search, "broadcast-search", 0, sizeof(s_network_message_broadcast_search), sizeof(s_network_message_broadcast_search), c_network_message_broadcast_search::encode, c_network_message_broadcast_search::decode, nullptr, nullptr);
    ...
    message_collection->register_message_type(_network_message_broadcast_reply, "broadcast-reply", 0, sizeof(s_network_message_broadcast_reply), sizeof(s_network_message_broadcast_reply), c_network_message_broadcast_reply::encode, c_network_message_broadcast_reply::decode, nullptr, nullptr);
}
