...
public:
	...
	void handle_join_abort(transport_address const* address, s_network_message_join_abort const* message);
	void handle_join_refuse(transport_address const* address, s_network_message_join_refuse const* message);
	void handle_join_request(transport_address const* address, s_network_message_join_request const* message);
	...
	void handle_ping(transport_address const* address, s_network_message_ping const* message);
	...
	void handle_pong(transport_address const* address, s_network_message_pong const* message);
	void handle_session_boot(transport_address const* address, s_network_message_session_boot const* message);
	void handle_session_disband(transport_address const* address, s_network_message_session_disband const* message);
	...
	bool initialize_handler(c_network_link* link, c_network_message_type_collection const* message_types, c_network_message_gateway* message_gateway);
	...
	void handle_directed_search(transport_address const* address, s_network_message_directed_search const* message);
	void handle_text_chat(c_network_channel* channel, s_network_message_text_chat const* message);
