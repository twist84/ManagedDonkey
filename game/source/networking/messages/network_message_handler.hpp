...
union network_message_converter_t
{
	...
	s_network_message_text_chat const* message_text_chat;
...
public:
	...
	void __cdecl handle_channel_message(c_network_channel* channel, e_network_message_type message_type, long message_storage_size, void const* message_storage);
	...
	void __cdecl handle_view_establishment(c_network_channel* channel, s_network_message_view_establishment const* message);
