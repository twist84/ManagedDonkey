...
bool __cdecl c_network_message_synchronous_actions::compare(int32 a1, void* a2, void* a3)
{
	return INVOKE(0x004E0490, compare, a1, a2, a3);
}

bool __cdecl c_network_message_synchronous_update::compare(int32 a1, void* a2, void* a3)
{
	return INVOKE(0x004E0500, compare, a1, a2, a3);
}

bool __cdecl c_network_message_synchronous_acknowledge::decode(c_bitstream* packet, int32 message_storage_size, void* message_storage)
{
	return INVOKE(0x004E05B0, decode, packet, message_storage_size, message_storage);
}

bool __cdecl c_network_message_synchronous_actions::decode(c_bitstream* packet, int32 message_storage_size, void* message_storage)
{
	return INVOKE(0x004E05E0, decode, packet, message_storage_size, message_storage);
}

bool __cdecl c_network_message_synchronous_gamestate::decode(c_bitstream* packet, int32 message_storage_size, void* message_storage)
{
	return INVOKE(0x004E0690, decode, packet, message_storage_size, message_storage);
}

bool __cdecl c_network_message_synchronous_playback_control::decode(c_bitstream* packet, int32 message_storage_size, void* message_storage)
{
	return INVOKE(0x004E0730, decode, packet, message_storage_size, message_storage);
}

bool __cdecl c_network_message_synchronous_update::decode(c_bitstream* packet, int32 message_storage_size, void* message_storage)
{
	return INVOKE(0x004E07A0, decode, packet, message_storage_size, message_storage);
}

void __cdecl c_network_message_synchronous_actions::dispose(int32 a1, void* a2)
{
	INVOKE(0x004E0870, dispose, a1, a2);
}

void __cdecl c_network_message_synchronous_update::dispose(int32 a1, void* a2)
{
