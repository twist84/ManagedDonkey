...
//void __cdecl player_configuration_client_encode(c_bitstream* packet, const s_player_configuration_from_client* player_from_client, e_player_configuration_encoding_type encoding_type)
