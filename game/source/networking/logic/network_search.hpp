...
extern bool __cdecl network_search_start(int32 controller_index, int32 category, int32 maximum_sessions, uint32 available_squad_search_flags, c_allocation_base* session_allocator);
