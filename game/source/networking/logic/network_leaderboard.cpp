...
//.text:004D5830 ; void __cdecl network_leaderboard_build_leaderboard_game_results_from_initial(uint16 hopper_identifier, bool is_ranked, bool team_game, int32 draw_probability, real32 beta, real32 tau, int32 experience_penalty_decrement, uint32 start_time, s_network_leaderboard_game_results* game_results)
//.text:004D58A0 ; void __cdecl network_leaderboard_build_leaderboard_player_game_results_from_game_results(int32 player_index, s_network_leaderboard_game_results const* leaderboard_game_results, c_game_results const* game_results, int32 relative_score, s_network_leaderboard_player_game_results* player_game_results_out)
...
//.text:004D5B90 ; void __cdecl network_leaderboard_build_query_from_statistic_list(s_online_stat_query* stat_query, e_online_leaderboard_id leaderboard_id, int32 leaderboard_statistics_count, e_leaderboard_statistic const* leaderboard_statistics)
...
//.text:004D6070 ; int32 sub_4D6070(uint64 xuid) // get valid query user index?
...
//.text:004D6B30 ; void __cdecl network_leaderboard_write_initial_stats(int32 managed_session_index, uint16 hopper_identifier, bool is_ranked, bool team_game, int32 draw_probability, real32 beta, real32 tau, int32 experience_penalty_decrement, uint32 selection_time, game_player_options const* player_options)
//.text:004D6CB0 ; void __cdecl network_leaderboard_write_stats(int32 managed_session_index, c_game_results const* game_results)
//.text:004D6DC0 ; void __cdecl network_leaderboard_write_stats_internal(int32 managed_session_index, s_network_leaderboard_game_results const* game_results, s_network_leaderboard_player_game_results const* player_game_results, bool a4)
