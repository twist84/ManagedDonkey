...
typedef int16 c_end_game_write_stats_flags;
...
//protected:
	...
	c_end_game_write_stats_flags m_flags;
};
static_assert(sizeof(c_life_cycle_state_handler_end_game_write_stats) == 0x30);
static_assert(0x28 == OFFSETOF(c_life_cycle_state_handler_end_game_write_stats, m_end_game_write_stats_start_time));
static_assert(0x2C == OFFSETOF(c_life_cycle_state_handler_end_game_write_stats, m_flags));
