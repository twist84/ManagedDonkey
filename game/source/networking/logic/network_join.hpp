...
//0x0047E290;	e_life_cycle_join_result __cdecl network_join_get_squad_join_result(e_network_join_squad_join_source)
...
//0x0047E510;	void __cdecl network_join_leave_group_session_and_swap_if_necessary(e_networking_join_destination_squad)
