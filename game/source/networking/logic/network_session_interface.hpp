...
extern void __cdecl network_session_interface_notify_set_local_specific_film(const s_saved_film_description* film);
...
extern void __cdecl network_session_interface_set_local_user_override_hopper_directory(int32 user_index, const char* override_hopper_directory);
