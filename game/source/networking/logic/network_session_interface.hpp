...
COMPILE_ASSERT(sizeof(s_network_session_interface_user) == 0x1698);
COMPILE_ASSERT(0x0000 == OFFSETOF(s_network_session_interface_user, user_state));
COMPILE_ASSERT(0x0004 == OFFSETOF(s_network_session_interface_user, player_identifier));
COMPILE_ASSERT(0x000C == OFFSETOF(s_network_session_interface_user, controller_index));
COMPILE_ASSERT(0x0010 == OFFSETOF(s_network_session_interface_user, player_data));
COMPILE_ASSERT(0x1630 == OFFSETOF(s_network_session_interface_user, player_update_number));
COMPILE_ASSERT(0x1634 == OFFSETOF(s_network_session_interface_user, override_hopper_directory));
COMPILE_ASSERT(0x1674 == OFFSETOF(s_network_session_interface_user, player_voice_settings));
COMPILE_ASSERT(0x1674 == OFFSETOF(s_network_session_interface_user, player_mute_mask));
COMPILE_ASSERT(0x1676 == OFFSETOF(s_network_session_interface_user, player_voice_flags));
COMPILE_ASSERT(0x1678 == OFFSETOF(s_network_session_interface_user, session_to_change_teams_on));
COMPILE_ASSERT(0x167C == OFFSETOF(s_network_session_interface_user, desired_team_index));
COMPILE_ASSERT(0x1680 == OFFSETOF(s_network_session_interface_user, user_update_timestamp));
COMPILE_ASSERT(0x168C == OFFSETOF(s_network_session_interface_user, user_remove_timestamp));
...
COMPILE_ASSERT(sizeof(s_saved_film_description) == 0x31C);
COMPILE_ASSERT(0x000 == OFFSETOF(s_saved_film_description, category));
COMPILE_ASSERT(0x004 == OFFSETOF(s_saved_film_description, campaign_id));
COMPILE_ASSERT(0x008 == OFFSETOF(s_saved_film_description, map_id));
COMPILE_ASSERT(0x00C == OFFSETOF(s_saved_film_description, campaign_insertion_point));
COMPILE_ASSERT(0x00E == OFFSETOF(s_saved_film_description, campaign_survival_enabled));
COMPILE_ASSERT(0x010 == OFFSETOF(s_saved_film_description, difficulty));
COMPILE_ASSERT(0x014 == OFFSETOF(s_saved_film_description, film_path));
COMPILE_ASSERT(0x214 == OFFSETOF(s_saved_film_description, film_name));
COMPILE_ASSERT(0x314 == OFFSETOF(s_saved_film_description, controller_index));
COMPILE_ASSERT(0x318 == OFFSETOF(s_saved_film_description, length_seconds));
...
COMPILE_ASSERT(sizeof(s_network_session_interface_globals) == 0x5F08);
COMPILE_ASSERT(0x0000 == OFFSETOF(s_network_session_interface_globals, initialized));
COMPILE_ASSERT(0x0002 == OFFSETOF(s_network_session_interface_globals, machine_name));
COMPILE_ASSERT(0x0022 == OFFSETOF(s_network_session_interface_globals, session_name));
COMPILE_ASSERT(0x0062 == OFFSETOF(s_network_session_interface_globals, live_service_qos_valid));
COMPILE_ASSERT(0x0064 == OFFSETOF(s_network_session_interface_globals, live_service_qos_result));
COMPILE_ASSERT(0x0084 == OFFSETOF(s_network_session_interface_globals, live_estimated_bandwidth_bps));
COMPILE_ASSERT(0x0088 == OFFSETOF(s_network_session_interface_globals, live_max_machine_count));
COMPILE_ASSERT(0x008C == OFFSETOF(s_network_session_interface_globals, flags));
COMPILE_ASSERT(0x0090 == OFFSETOF(s_network_session_interface_globals, ready_hopper_identifier));
COMPILE_ASSERT(0x0094 == OFFSETOF(s_network_session_interface_globals, game_start_error));
COMPILE_ASSERT(0x0098 == OFFSETOF(s_network_session_interface_globals, guide_opened_during_multiplayer_session));
COMPILE_ASSERT(0x009C == OFFSETOF(s_network_session_interface_globals, current_map_id));
COMPILE_ASSERT(0x00A0 == OFFSETOF(s_network_session_interface_globals, current_map_status));
COMPILE_ASSERT(0x00A4 == OFFSETOF(s_network_session_interface_globals, current_map_progress_percentage));
COMPILE_ASSERT(0x00A8 == OFFSETOF(s_network_session_interface_globals, current_display_level_hopper_identifier));
COMPILE_ASSERT(0x00B0 == OFFSETOF(s_network_session_interface_globals, users));
COMPILE_ASSERT(0x5B10 == OFFSETOF(s_network_session_interface_globals, current_game_instance));
COMPILE_ASSERT(0x5B18 == OFFSETOF(s_network_session_interface_globals, persistent_progress_scenario_type));
COMPILE_ASSERT(0x5B1C == OFFSETOF(s_network_session_interface_globals, persistent_progress_scenario_path));
COMPILE_ASSERT(0x5B9C == OFFSETOF(s_network_session_interface_globals, persistent_campaign_insertion_point_index));
COMPILE_ASSERT(0x5B9E == OFFSETOF(s_network_session_interface_globals, persistent_load_status));
COMPILE_ASSERT(0x5BA0 == OFFSETOF(s_network_session_interface_globals, persistent_progress_initial));
COMPILE_ASSERT(0x5BA4 == OFFSETOF(s_network_session_interface_globals, local_saved_film_description));
COMPILE_ASSERT(0x5EC0 == OFFSETOF(s_network_session_interface_globals, local_saved_film_description_timestamp));
COMPILE_ASSERT(0x5EC4 == OFFSETOF(s_network_session_interface_globals, session_connection_identifier));
COMPILE_ASSERT(0x5ED0 == OFFSETOF(s_network_session_interface_globals, peer_update_timestamp));
COMPILE_ASSERT(0x5EDC == OFFSETOF(s_network_session_interface_globals, membership_update_number));
COMPILE_ASSERT(0x5EE8 == OFFSETOF(s_network_session_interface_globals, variant_is_team_game));
COMPILE_ASSERT(0x5EEB == OFFSETOF(s_network_session_interface_globals, session_variant_has_sve_teams));
COMPILE_ASSERT(0x5EEE == OFFSETOF(s_network_session_interface_globals, variant_are_observers_allowed));
COMPILE_ASSERT(0x5EF4 == OFFSETOF(s_network_session_interface_globals, variant_team_count));
COMPILE_ASSERT(0x5F00 == OFFSETOF(s_network_session_interface_globals, session_manager));
