...
extern bool __cdecl transport_qos_listener_get_stats(s_transport_secure_identifier const* secure_id, s_transport_qos_listener_stats* transport_qos_listener_stats_out);
extern bool __cdecl transport_qos_listener_initiate(s_transport_secure_identifier const* secure_id);
extern void __cdecl transport_qos_listener_set_bandwidth_limit(s_transport_secure_identifier const* secure_id, bool enabled, int32 outgoing_bps);
extern void __cdecl transport_qos_listener_set_reply_block(s_transport_secure_identifier const* secure_id, bool enabled, int32 reply_block_size, void const* reply_block);
extern void __cdecl transport_qos_listener_terminate(s_transport_secure_identifier const* secure_id);
