...
extern bool __cdecl transport_endpoint_get_socket_address(transport_address const* address, int32* socket_address_size, uint8* const socket_address);
extern bool __cdecl transport_endpoint_get_transport_address(int32 socket_address_length, uint8 const* const socket_address, transport_address* address);
