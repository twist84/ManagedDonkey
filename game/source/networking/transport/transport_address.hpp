...
extern char* __cdecl transport_address_to_string(transport_address const* address, s_transport_secure_address const* secure_address, char* _string, int16 maximum_string_length, bool include_port, bool include_extra);
