...
HOOK_DECLARE_CLASS_MEMBER(0x00431440, c_online_lsp_manager, _acquire_server);
...
long __thiscall c_online_lsp_manager::_acquire_server(long service_type, long* connection_token_out, long* ip_address, unsigned short* port, char const* service_description)
{
	return 0;
}
