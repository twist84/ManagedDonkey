...
extern void __cdecl create_machine_url_base(c_url_string* url, uint64 machine_id);
extern void __cdecl create_title_url_base(c_url_string* url);
extern void __cdecl create_user_url_base(c_url_string* url, uint64 user_id);
...
extern void __cdecl online_url_make_bnet_consume_begin(c_url_string* url, uint64 user_id, uint32 consumable_id);
extern void __cdecl online_url_make_bnet_consume_complete(c_url_string* url, uint64 user_id, uint32 consumable_id);
extern void __cdecl online_url_make_bnet_subscription_get_details(c_url_string* url, uint64 user_id, int32 game_region, int32 profile_region, bool extras_portal_debug);
...
extern void __cdecl online_url_make_matchmaking_game_variant(c_url_string* url, uint16 hopper_id, char const* variant_name);
extern void __cdecl online_url_make_matchmaking_gameset(c_url_string* url, uint16 hopper_id);
extern void __cdecl online_url_make_matchmaking_histogram(c_url_string* url, uint16 hopper_id, int32 hopper_skill);
extern void __cdecl online_url_make_matchmaking_hopper(c_url_string* url);
extern void __cdecl online_url_make_matchmaking_machine(c_url_string* url, uint64 machine_id);
extern void __cdecl online_url_make_matchmaking_map_variant(c_url_string* url, uint16 hopper_id, char const* variant_name);
...
extern void __cdecl online_url_make_matchmaking_user(c_url_string* url, uint64 user_id);
extern void __cdecl online_url_make_matchmaking_user_recent_players(c_url_string* url, uint64 user_id);
...
extern void __cdecl online_url_make_update_user_highest_skill(c_url_string* url, uint64 user_id, int32 highest_skill);
extern void __cdecl online_url_make_upload_saved_screenshot(c_url_string* url);
extern void __cdecl online_url_make_user_service_record(c_url_string* url, uint64 user_id);
