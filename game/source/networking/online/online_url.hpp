...
extern void __cdecl online_url_make_bnet_subscription_get_details(c_url_string* url, uint64 user_id, long game_region, long profile_region, bool extras_portal_debug);
...
extern void __cdecl online_url_make_matchmaking_histogram(c_url_string* url, uint16 hopper_id, long hopper_skill);
...
extern void __cdecl online_url_make_update_user_highest_skill(c_url_string* url, uint64 user_id, long highest_skill);
