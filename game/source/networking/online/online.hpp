...
extern void __cdecl online_get_title_name_string(uint32 title_id, wchar_t* buffer, int32 buffer_length);
...
extern void __cdecl online_user_set_name(int32 user_index, wchar_t const* name);
