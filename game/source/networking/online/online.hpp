...
extern qword __cdecl online_local_user_get_player_identifier(e_controller_index controller_index);
extern qword __cdecl online_local_user_get_xuid(e_controller_index controller_index);
