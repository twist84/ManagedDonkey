...
struct s_main_time_globals
{
	...
	__int64 last_input_timestamp;
	__int64 last_publish_start_timestamp;
	__int64 last_publish_end_timestamp;
};
...
extern long __cdecl main_time_get_time_since_input_collection(__int64 timestamp);
...
extern void __cdecl main_time_restore(long game_state_flags);
