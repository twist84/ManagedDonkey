...
extern void __cdecl loading_basic_progress_phase_begin(long phase, uint32 update_size);
...
extern real32 __cdecl main_load_map_loading_progress(long scenario_type, short a2, char const* scenario_path);
