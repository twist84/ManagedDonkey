...
extern void __cdecl editor_dispose_from_old_structure_bsp(uint32 deactivating_structure_bsp_mask);
...
extern void __cdecl editor_initialize_for_new_structure_bsp(uint32 activating_structure_bsp_mask);
