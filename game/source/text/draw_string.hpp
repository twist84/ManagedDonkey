...
struct c_draw_string
{
	...
	struct
	{
		...
		void(__thiscall* draw_character)(c_draw_string* _this, c_font_cache_base* font_cache, e_font_id font_id, e_utf32 character, uint32 a4, uint32 a5, real32 a6, real32 a7, real32 a8, real32 a9, real32 a10, real32 a11);
	}* __vftable;
...
public:
	...
	void draw_character(c_font_cache_base* font_cache, e_font_id font_id, e_utf32 character, uint32 a4, uint32 a5, real32 a6, real32 a7, real32 a8, real32 a9, real32 a10, real32 a11)
	{
