...
extern void __cdecl hs_bitmap_predict(int32 bitmap_group_index);
extern void __cdecl hs_damage_new(int32 definition_index, int16 flag_index);
extern void __cdecl hs_damage_object(int32 object_index, int32 material_name, real32 damage_amount);
extern void __cdecl hs_damage_object_effect(int32 definition_index, int32 object_index);
extern void __cdecl hs_damage_object_effect_list(int32 definition_index, int32 object_list_index);
extern void __cdecl hs_damage_object_list(int32 object_list_index, int32 material_name, real32 damage_amount);
extern void __cdecl hs_damage_players(int32 definition_index);
extern void __cdecl hs_debug_variable(const char* s, bool debug);
extern void __cdecl hs_debug_variable_all(bool enable);
extern void __cdecl hs_effect_new(int32 definition_index, int16 flag_index);
extern void __cdecl hs_effect_new_at_ai_point(int32 definition_index, int32 point_ref);
extern void __cdecl hs_effect_new_from_object_marker(int32 definition_index, int32 object_index, int32 marker_id);
extern void __cdecl hs_effect_new_on_ground(int32 definition_index, int32 object_index);
extern void __cdecl hs_effect_new_random(int32 definition_index, int32 point_ref);
...
extern real32 __cdecl hs_object_buckling_magnitude_get(int32 object_index);
...
extern real32 __cdecl hs_pin(real32 value, real32 min, real32 max);
extern int32 __cdecl hs_player_get(int32 contiguous_player_index);
