...
// $TODO with `hs_function_definition` defined make sure to add a new `macro_function_evaluate`
// or make a prebuild step that generates each `macro_function_evaluate`
