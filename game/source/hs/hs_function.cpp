...
enum
{
	// Don't forget to update this more functions are defined
	k_number_of_hs_functions_definitions_defined = _hs_function_set + 1,
};
...
extern const hs_function_definition_release* (&hs_function_table_release)[k_maximum_number_of_ms23_hs_functions];

REFERENCE_DECLARE_ARRAY(0x018ED378, const hs_function_definition_release*, hs_function_table_release, k_maximum_number_of_ms23_hs_functions);
...
const char* const hs_function_table_names[k_maximum_number_of_ms23_hs_functions]
{
	// 0
	"begin",
...
{
	for (int32 function_index = k_number_of_hs_functions_definitions_defined; function_index < k_maximum_number_of_ms23_hs_functions; function_index++)
	{
		const hs_function_definition_release* function_release = hs_function_table_release[function_index];
		hs_function_definition* function = hs_function_table[function_index];

		function->return_type = function_release->return_type;
		function->name = hs_function_table_names[function_index];
		function->flags = function_release->flags;
		function->evaluate = function_release->evaluate;

		function->documentation = "";
		function->parameters = function_release->parameters;

		if (function->formal_parameter_count = function_release->formal_parameter_count)
		{
			csmemcpy(function->formal_parameters, function_release->formal_parameters, sizeof(int16) * function->formal_parameter_count);
		}
		...
		{
			function->parse = hs_parse_begin;
		}
		break;
		case _hs_function_if:
		{
			function->parse = hs_parse_if;
		}
		break;
		case _hs_function_cond:
		{
			function->parse = hs_parse_cond;
		}
		break;
		case _hs_function_set:
		{
			function->parse = hs_parse_set;
		}
		break;
		case _hs_function_and:
		case _hs_function_or:
		{
			function->parse = hs_parse_logical;
		}
		break;
		...
		{
			function->parse = hs_parse_arithmetic;
		}
		break;
		case _hs_function_equal:
		case _hs_function_not_equal:
		{
			function->parse = hs_parse_equality;
		}
		break;
		...
		{
			function->parse = hs_parse_inequality;
		}
		break;
		case _hs_function_sleep:
		{
			function->parse = hs_parse_sleep;
		}
		break;
		case _hs_function_sleep_forever:
		{
			function->parse = hs_parse_sleep_forever;
		}
		break;
		case _hs_function_sleep_until:
		{
			function->parse = hs_parse_sleep_until;
		}
		break;
		case _hs_function_wake:
		{
			function->parse = hs_parse_wake;
		}
		break;
		case _hs_function_inspect:
		{
			function->parse = hs_parse_inspect;
		}
		break;
		case _hs_function_object_to_unit:
		{
			function->parse = hs_parse_object_cast_up;
		}
		break;
		default:
		{
			function->parse = hs_macro_function_parse;
		}
		break;
		}
	}
...
int32 const hs_function_table_count_ = set_hs_function_table_debug_count();
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) havok_profile_stop_0_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) unknownBE_1_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) unit_in_vehicle_type_mask_2_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_set_targeting_group_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_teleport_to_starting_location_if_outside_bsp_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_teleport_to_spawn_point_if_outside_bsp_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_teleport_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_bring_forward_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_migrate_form_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_morph_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_biped_morph_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_renew_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_force_active_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_force_active_by_unit_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_playfight_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_ai_reconnect_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_berserk_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_set_team_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_allow_dormant_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_is_attacking_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_fighting_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_living_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_living_fraction_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_in_vehicle_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_body_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_strength_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_swarm_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_nonswarm_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_actors_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_allegiance_broken_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_spawn_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_object_get_ai_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) hs_ai_rotate_scenario_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_translate_scenario_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_scenario_duplicate_bsp_objects_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_scenario_duplicate_bsp_objects_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) hs_scenario_rotate_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) hs_scenario_reflect_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_scenario_translate_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) hs_scenario_rotate_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) hs_scenario_reflect_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) hs_scenario_translate_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_set_task_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) ai_set_objective_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) ai_task_status_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) ai_set_task_condition_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_leadership_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_leadership_all_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_task_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_reset_objective_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_squad_patrol_objective_disallow_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_generate_pathfinding_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_ai_render_paths_all_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_activity_set_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_activity_abort_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_get_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_get_from_starting_location_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_get_from_spawn_point_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_get_squad_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_vehicle_get_from_squad_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_vehicle_reserve_seat_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_vehicle_reserve_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_player_get_vehicle_squad_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_count_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_carrying_player_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_player_in_vehicle_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_player_needs_vehicle_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_ai_player_any_needs_vehicle_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_vehicle_enter_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_vehicle_enter_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_vehicle_enter_immediate_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_vehicle_enter_immediate_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_enter_squad_vehicles_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_vehicle_exit_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_vehicle_exit_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vehicle_overturned_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vehicle_flip_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_combat_status_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_flock_start_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_flock_stop_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_flock_create_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_flock_delete_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_flock_definition_set_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_flock_unperch_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_drop_ai_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_ai_verify_tags_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_ai_wall_lean_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_play_line_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_play_line_at_player_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_ai_play_line_on_object_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_play_line_on_object_for_team_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_ai_play_line_on_point_set_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) hs_ai_play_line_on_point_set_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_campaign_metagame_time_pause_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_campaign_metagame_award_points_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_campaign_metagame_award_primary_skull_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_campaign_metagame_award_secondary_skull_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_campaign_metagame_award_medall_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_metagame_enabled_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_survival_enabled_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_is_finished_easy_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_is_finished_normal_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_is_finished_heroic_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_campaign_is_finished_legendary_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_cs_run_command_script_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_cs_queue_command_script_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_cs_stack_command_script_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_vs_reserve_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) hs_vs_reserve_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_cast_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_cast_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) vs_cast_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 14) vs_cast_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 16) vs_cast_5_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 18) vs_cast_6_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 20) vs_cast_7_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_role_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vs_abort_on_alert_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vs_abort_on_damage_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vs_abort_on_combat_status_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_vs_abort_on_vehicle_exit_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_alert_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_damage_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_combat_status_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_vehicle_exit_0_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_alert_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_vs_abort_on_alert_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_damage_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_vs_abort_on_damage_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_combat_status_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_vs_abort_on_combat_status_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_cs_abort_on_vehicle_exit_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) hs_vs_abort_on_vehicle_exit_1_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_set_cleanup_script_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_release_thread_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) vs_release_all_thread_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_command_script_running_op;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_cs_moving_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_cs_moving_0_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_fly_to_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_fly_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_fly_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_fly_to_and_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_fly_to_and_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_fly_to_and_face_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_fly_to_and_face_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_fly_by_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_fly_by_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_fly_by_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_fly_by_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_go_to_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_go_to_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_go_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_go_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_go_by_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_go_by_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_go_by_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_go_by_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_go_to_and_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_go_to_and_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_go_to_and_posture_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_go_to_and_posture_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_go_to_nearest_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_go_to_nearest_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_move_in_direction_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_move_in_direction_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_move_towards_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_move_towards_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_move_towards_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_move_towards_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_move_towards_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_move_towards_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_swarm_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_swarm_to_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_swarm_from_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_swarm_from_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_pause_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_pause_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_grenade_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_grenade_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_equipment_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_equipment_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_jump_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_jump_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_jump_to_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_jump_to_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_vocalize_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_vocalize_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_play_sound_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_play_sound_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_play_sound_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_play_sound_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_play_sound_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_play_sound_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_action_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_action_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_action_at_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_action_at_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_action_at_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_action_at_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_custom_animation_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_custom_animation_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cs_custom_animation_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) vs_custom_animation_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_custom_animation_death_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_custom_animation_death_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cs_custom_animation_death_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) vs_custom_animation_death_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_custom_animation_loop_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_custom_animation_loop_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cs_custom_animation_loop_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_custom_animation_loop_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_play_line_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_play_line_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_die_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_die_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_deploy_turret_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_deploy_turret_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cs_approach_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 12) vs_approach_4_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cs_approach_player_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) vs_approach_player_3_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_go_to_vehicle_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_go_to_vehicle_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_go_to_vehicle_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) vs_go_to_vehicle_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_set_style_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_set_style_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_force_combat_status_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_force_combat_status_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_enable_targeting_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_enable_targeting_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_enable_looking_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_enable_looking_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_enable_moving_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_enable_moving_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_enable_dialogue_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_enable_dialogue_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_suppress_activity_termination_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_suppress_activity_termination_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_suppress_dialogue_global_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_suppress_dialogue_global_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_look_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_look_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_look_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_look_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_look_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_look_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_aim_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_aim_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_aim_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_aim_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_aim_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_aim_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_face_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_face_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_face_player_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_face_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_face_object_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_shoot_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_shoot_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_shoot_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_shoot_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_shoot_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_shoot_point_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_shoot_secondary_trigger_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_shoot_secondary_trigger_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_lower_weapon_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_lower_weapon_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_vehicle_speed_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_vehicle_speed_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_vehicle_speed_instantaneous_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_vehicle_speed_instantaneous_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_vehicle_boost_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_vehicle_boost_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_turn_sharpness_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_turn_sharpness_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_enable_pathfinding_failsafe_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_enable_pathfinding_failsafe_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_set_pathfinding_radius_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_set_pathfinding_radius_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_ignore_obstacles_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_ignore_obstacles_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_approach_stop_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_approach_stop_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_movement_mode_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_movement_mode_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_crouch_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_crouch_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_crouch_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_crouch_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_walk_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_walk_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_posture_set_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_posture_set_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_posture_exit_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_posture_exit_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_stow_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_stow_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_draw_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_draw_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cs_teleport_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_teleport_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cs_stop_custom_animation_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) vs_stop_custom_animation_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_stop_sound_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) vs_stop_sound_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_player_melee_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_player_melee_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_melee_direction_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_melee_direction_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) cs_smash_direction_1_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) vs_smash_direction_1_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) player_action_test_zoom_0_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_1673D60;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_1673E44;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_1673F34;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_1674044;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_167422C;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_167430C;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) stru_16743CC;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_player_action_test_left_shoulder_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) hs_player_action_test_right_shoulder_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_player_action_test_waypoint_activate_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_reset_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_grenade_trigger_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_vision_trigger_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_rotate_weapons_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_rotate_grenades_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_melee_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_action_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_accept_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_cancel_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_look_relative_up_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_look_relative_down_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_look_relative_left_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_look_relative_right_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_look_relative_all_directions_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_move_relative_all_directions_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_back_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_dpad_left_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_dpad_right_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_dpad_up_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_dpad_down_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_x_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_y_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_left_shoulder_op;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_unit_action_test_right_shoulder_op;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) cubemap_dynamic_generate_0_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) unknown347_5_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) unknown34B_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) game_multiplayer_1_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) cinematic_lighting_update_dynamic_light_directionl_5_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 6) cinematic_scripting_destroy_object_4_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) cinematic_scripting_create_and_animate_object_7_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) cinematic_scripting_create_and_animate_cinematic_object_6_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cinematic_scripting_create_and_animate_object_no_animation_6_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 8) cinematic_scripting_create_and_animate_cinematic_object_no_animation_5_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_game_level_advance_op;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) cinematic_screen_effect_set_crossfade2_2_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) user_interface_controller_get_last_level_played_1_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 10) controller_set_emblem_info_3_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) hs_determinism_debug_manager_enable_log_file_comparision_on_oos_op;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) game_achievements_display_achievement_names_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 4) game_grant_achievement_to_controller_by_string_2_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) game_grant_all_achievements_to_controller_1_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) unknown67D_0_definition;
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 0) unknown67E_0_definition;
...
DEFINE_HS_FUNCTION_DEFINITION_STRUCT(hs_function_definition, 2) local_player_earn_wp_event_op_1_definition;
