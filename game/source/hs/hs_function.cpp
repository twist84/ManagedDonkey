...
#define MACRO_FUNCTION_EVALUATE_CALL_IMPL(FUNCTION_RETURN, FUNCTION, ARG_COUNT) reinterpret_cast<FUNCTION_RETURN(__cdecl*)(ARGS_FUNC_##ARG_COUNT)>(FUNCTION)(ARGS_CALL_##ARG_COUNT)

#define MACRO_FUNCTION_EVALUATE_CALL(RETURN_TYPE, FUNCTION, RESULT, ARG_COUNT) \
if constexpr (RETURN_TYPE == _hs_type_void) \
{ \
    MACRO_FUNCTION_EVALUATE_CALL_IMPL(void, FUNCTION, ARG_COUNT); \
} \
else \
{ \
    RESULT = MACRO_FUNCTION_EVALUATE_CALL_IMPL(int32, FUNCTION, ARG_COUNT); \
} \
hs_return(thread_index, RESULT);

#define MACRO_FUNCTION_EVALUATE_BODY(RETURN_TYPE, FUNCTION, RESULT, ARG_COUNT) \
if (int32* actual_parameters = hs_macro_function_evaluate(function_index, thread_index, initialize)) \
{ \
    MACRO_FUNCTION_EVALUATE_CALL(RETURN_TYPE, FUNCTION, RESULT, ARG_COUNT) \
}

#define MACRO_FUNCTION_EVALUATE_IMPL_0(RETURN_TYPE,  FUNCTION, RESULT) MACRO_FUNCTION_EVALUATE_CALL(RETURN_TYPE, FUNCTION, RESULT, 0)
...
MACRO_FUNCTION_EVALUATE2(hs_function_definition, 2,
	...
	tag_reload_force,
	0,
	0x0072F840, // tag_groups_sync_reload_fake, $TODO write the function chuckle nuts
...
MACRO_FUNCTION_EVALUATE2(hs_function_definition, 2,
	...
	string_id_name,
	0,
	0x00731D70, // string_id_print_name, $TODO write the function chuckle nuts
