...
//.text:005256D0 ; long __cdecl saved_game_files_create(e_controller_index, wchar_t const*, e_saved_game_file_type, c_synchronized_long*, c_synchronized_long*, c_synchronized_long*)
//.text:00525760 ; e_async_completion __cdecl saved_game_files_create_callback(s_async_task*)
//.text:005258E0 ; long __cdecl saved_game_files_create_content_item_and_copy_file(e_controller_index, e_game_content_type, wchar_t const*, char const*, c_synchronized_long*, c_synchronized_long*, long*)
...
//.text:00525F00 ; bool __cdecl saved_game_files_get_default_film_save_description(e_controller_index, e_gui_game_mode, wchar_t const*, wchar_t const*, e_campaign_difficulty_level, wchar_t*, long)
...
//.text:00526270 ; bool __cdecl saved_game_files_get_default_screenshot_save_description(e_controller_index, e_gui_game_mode, wchar_t const*, wchar_t const*, e_campaign_difficulty_level, wchar_t*, long)
...
//.text:005268C0 ; bool __cdecl saved_game_files_is_content_item_corrupt(e_controller_index, long)
...
//.text:00526A00 ; long __cdecl saved_game_files_read(e_controller_index, long, e_saved_game_file_type, s_blffile_saved_game_file*, uint32, c_synchronized_long*, c_synchronized_long*)
//.text:00526A90 ; public: void s_saved_game_file_globals::register_text_parsers(s_saved_game_file_text_parser_input const*)
//.text:00526B00 ; void __cdecl saved_game_files_remove_corrupt_content_item(e_controller_index, long)
...
//.text:00526B80 ; long __cdecl saved_game_files_save_last_film(e_controller_index, c_synchronized_long*, c_synchronized_long*, wchar_t*, long)
//.text:00526BB0 ; long __cdecl saved_game_files_save_last_film_to_debugging_hard_drive(e_controller_index, void*, uint32, c_synchronized_long*, c_synchronized_long*)
...
//.text:00527040 ; long __cdecl saved_game_files_write(e_controller_index, long, e_saved_game_file_type, s_blffile_saved_game_file const*, uint32, c_synchronized_long*, c_synchronized_long*)
