...
struct s_saved_game_item_metadata
{
	...
	void initialize(e_controller_index controller_index, e_saved_game_file_type file_type, const wchar_t* in_name, const wchar_t* in_description, uns64 unique_id, uns64 size);
