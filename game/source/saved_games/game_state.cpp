...
void __cdecl initialize_game_state_section(int32 section_index, unsigned int size, uint8** starting_address, uint32* available_memory, e_critical_sections critical_section_id)
{
