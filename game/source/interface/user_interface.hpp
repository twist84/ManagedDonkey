...
extern void __cdecl user_interface_render(e_controller_index controller_index, long user_index, long window, short_rectangle2d const* rect, long surface, bool a6);
