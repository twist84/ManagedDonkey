...
extern void __cdecl chud_draw_screen_LDR(e_output_user_index output_user_index);
...
extern bool __cdecl chud_generate_damage_flash_texture(e_output_user_index output_user_index);
