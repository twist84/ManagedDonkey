...
extern void __cdecl chud_add_noisemaker_zone(int32 datum_index, const real_point3d* position, real32 blip_radius, real32 flash_radius, int32 blip_count);
extern void __cdecl chud_apply_distortion(int32 user_index, int32 target_width, int32 target_height);
...
extern void __cdecl chud_picked_up_ammunition(int32 user_index, int32 weapon_definition_index, int16 count);
extern void __cdecl chud_picked_up_grenade(int32 user_index, int32 grenade_definition_index);
