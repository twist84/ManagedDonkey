...
public:
	...
	real_rectangle2d* get_current_bounds(real_rectangle2d* a1);
	real_rectangle2d* get_container_current_bounds(real_rectangle2d* a1);
	bool should_render(bool* a1);
	real_argb_color* get_cumulative_color_tint(real_argb_color* a1);
	bool can_receive_focus();
	bool within_focus_chain();
	c_gui_text_widget* create_text_widget(s_runtime_text_widget_definition const* a1);
	c_gui_bitmap_widget* create_bitmap_widget(s_runtime_bitmap_widget_definition const* a1);
	c_gui_group_widget* create_group_widget(s_group_widget_definition const* a1);
	c_gui_button_key_widget* create_button_key_widget(s_button_key_definition const* a1);
	c_gui_list_widget* create_list_widget(s_list_widget_block const* a1);
	c_gui_list_item_widget* create_list_item_widget(s_list_item_widget_block const* a1);
	c_gui_model_widget* create_model_widget(s_model_widget_block const* a1);
	void update(dword a1);
	void update_render_state(dword a1);
	void set_animated_state_baseline(s_animation_transform* a1);
	...
	bool handle_tab(c_controller_input_message const* input_message);
	bool handle_controller_input_message(c_controller_input_message const* input_message);
	bool get_string_by_string_id(string_id name, c_static_wchar_string<1024>* out_string);
	c_gui_bitmap_widget* get_next_bitmap_widget();
	c_gui_list_item_widget* get_next_list_item_widget(bool a1);
	c_gui_list_widget* get_next_list_widget();
	c_gui_model_widget* get_next_model_widget();
	c_gui_text_widget* get_next_text_widget();
	c_gui_widget* get_next_widget_of_type(e_gui_widget_type widget_type);
	...
	c_gui_widget* get_child_widget(e_gui_widget_type widget_type, string_id name);
	c_gui_bitmap_widget* get_child_bitmap_widget(string_id name);
	c_gui_group_widget* get_child_group_widget(string_id name);
	c_gui_list_item_widget* get_child_list_item_widget(string_id name);
	c_gui_list_widget* get_child_list_widget(string_id name);
	c_gui_model_widget* get_child_model_widget(string_id name);
