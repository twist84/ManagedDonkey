...
REFERENCE_DECLARE(0x05260708, dword, g_attract_mode_countdown_timer);
...
bool __cdecl attract_mode_get_movie_path(char const* movie_name, c_static_string<256>* out_fullpath)
{
