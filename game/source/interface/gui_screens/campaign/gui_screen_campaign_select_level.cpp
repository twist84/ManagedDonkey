...
//.text:00AFCC00 ; public: virtual c_gui_bitmap_widget* c_gui_screen_campaign_select_level::create_bitmap_widget(const s_runtime_bitmap_widget_definition*)
//.text:00AFCE00 ; public: virtual bool c_gui_screen_campaign_select_level::handle_controller_input_message(const c_controller_input_message*)
//.text:00AFCF20 ; public: virtual bool c_gui_screen_campaign_select_level::handle_dialog_result(const c_dialog_result_message*)
//.text:00AFCF90 ; public: virtual bool c_gui_screen_campaign_select_level::handle_list_item_chosen(const c_controller_input_message*, int32, c_gui_list_item_widget*, c_gui_data*)
