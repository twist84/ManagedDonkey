...
//.text:00AFCA00 ; public: c_gui_screen_campaign_select_level::c_gui_screen_campaign_select_level(long)
...
//.text:00AFCF90 ; public: virtual bool c_gui_screen_campaign_select_level::handle_list_item_chosen(c_controller_input_message const*, long, c_gui_list_item_widget*, c_gui_data*)
...
void __thiscall c_gui_screen_campaign_select_level::post_initialize_()
{
	...
	{
		DECLARE_LAMBDA2(get_element_handle, long, c_gui_screen_campaign_select_level* this_ptr, c_gui_data* level_data)
		{
			for (long element_handle = level_data->get_first_element_handle();
				element_handle != NONE;
		...
		long element_handle = get_element_handle(this, level_data);
