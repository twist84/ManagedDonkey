	...
	if (list_name == STRING_ID(gui, lobby_list))
	{
		...
		if (datasource->get_string_id_value(element_handle, STRING_ID(gui, target), &target_name))
		{
			if (target_name == STRING_ID(global, level))
			{
				...
				if (c_load_campaign_select_level_screen_message* screen_message = new (_ui_allocation_marker_dummy) c_load_campaign_select_level_screen_message(
			...
			{
				if (c_load_campaign_select_difficulty_screen_message* screen_message = new (_ui_allocation_marker_dummy) c_load_campaign_select_difficulty_screen_message(
...
void c_gui_screen_pregame_lobby_campaign::initialize()
{
	...
	c_gui_screen_widget::add_game_tag_parser(new (_ui_allocation_marker_dummy) c_magic_string_game_tag_parser(L"<lobby-campaign-level", this, parse_xml_lobby_campaign_level));
	c_gui_screen_widget::add_game_tag_parser(new (_ui_allocation_marker_dummy) c_magic_string_game_tag_parser(L"<lobby-campaign-difficulty", this, parse_xml_lobby_campaign_difficulty));
	c_gui_screen_widget::add_game_tag_parser(new (_ui_allocation_marker_dummy) c_magic_string_game_tag_parser(L"<lobby-campaign-insertion", this, parse_xml_lobby_campaign_insertion));
}
...
void c_gui_screen_pregame_lobby_campaign::load_progress_ui(e_controller_index controller_index)
{
	...
	//if (c_load_in_progress_screen_message* in_progress_screen_message = new (_ui_allocation_marker_dummy) c_load_in_progress_screen_message(
	//	controller_index,
	//	c_gui_screen_widget::get_render_window(),
