...
//.text:00AE8240 ; public: void c_http_blf_simple_downloader<s_message_of_the_day_popup>::set_url(c_url_string const*)
...
//.text:00AE8390 ; public: virtual void c_main_menu_screen_widget::update(uint32)
