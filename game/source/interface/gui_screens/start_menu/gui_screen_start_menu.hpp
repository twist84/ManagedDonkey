...
COMPILE_ASSERT(sizeof(s_start_menu_breadcrumb) == 0x8);
...
COMPILE_ASSERT(sizeof(c_start_menu_screen_widget) == 0x21B8);
COMPILE_ASSERT(sizeof(c_start_menu_screen_widget) == sizeof(c_gui_screen_widget) + 0x718);
COMPILE_ASSERT(0x1AA0 == offsetof(c_start_menu_screen_widget, m_owner_player_id));
COMPILE_ASSERT(0x1AA8 == offsetof(c_start_menu_screen_widget, m_target_player_id));
COMPILE_ASSERT(0x1AB0 == offsetof(c_start_menu_screen_widget, m_target_player_xuid));
COMPILE_ASSERT(0x1AB8 == offsetof(c_start_menu_screen_widget, m_service_record_identity));
COMPILE_ASSERT(0x2158 == offsetof(c_start_menu_screen_widget, m_old_film_playback_speed));
COMPILE_ASSERT(0x215C == offsetof(c_start_menu_screen_widget, m_breadcrumbs));
COMPILE_ASSERT(0x21A0 == offsetof(c_start_menu_screen_widget, m_requested_pane));
COMPILE_ASSERT(0x21A4 == offsetof(c_start_menu_screen_widget, m_breadcrumb_to_load_valid));
COMPILE_ASSERT(0x21A8 == offsetof(c_start_menu_screen_widget, m_breadcrumb_to_load));
COMPILE_ASSERT(0x21B0 == offsetof(c_start_menu_screen_widget, m_is_rooted));
COMPILE_ASSERT(0x21B1 == offsetof(c_start_menu_screen_widget, m_wants_to_pause_game_time));
