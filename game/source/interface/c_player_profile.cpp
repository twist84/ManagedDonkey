...
//.text:00AA07C0 ; public: bool __cdecl c_player_profile_interface::get_film_auto_save(e_film_auto_save_type) const
//.text:00AA07E0 ; 
//.text:00AA0800 ; 
//.text:00AA0810 ; 
...
void __thiscall c_player_profile_interface::set_primary_change_color(long primary_change_color, bool a2)
{
	...
	//else
	//{
	//	generate_event(_event_level_error, "ui:profile: invalid primary color index (#%ld)", primary_change_color);
	//}
}
...
void __thiscall c_player_profile_interface::set_secondary_change_color(long secondary_change_color, bool a2)
{
	...
	//else
	//{
	//	generate_event(_event_level_error, "ui:profile: invalid primary color index (#%ld)", secondary_change_color);
	//}
}
