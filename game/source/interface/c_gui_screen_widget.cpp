...
{
	return INVOKE_CLASS_MEMBER((dword)__vftable->__funcs[60], c_gui_screen_widget, get_gui_game_mode);
}
...
bool c_gui_screen_widget::handle_list_item_chosen(c_controller_input_message const* message, long list_name, c_gui_list_item_widget* list_item_widget, c_gui_data* datasource)
{
	...
	//return INVOKE_CLASS_MEMBER((dword)__vftable->__funcs[49], c_gui_screen_widget, handle_list_item_chosen, message, list_name, list_item_widget, datasource);
