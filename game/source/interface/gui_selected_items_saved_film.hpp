...
COMPILE_ASSERT(sizeof(c_gui_saved_film_selected_item) == 0x2B8);
COMPILE_ASSERT(sizeof(c_gui_saved_film_selected_item) == sizeof(c_gui_selected_item) + 0x128);
COMPILE_ASSERT(0x190 == OFFSETOF(c_gui_saved_film_selected_item, m_controller_index));
COMPILE_ASSERT(0x194 == OFFSETOF(c_gui_saved_film_selected_item, m_file_reference));
COMPILE_ASSERT(0x2A8 == OFFSETOF(c_gui_saved_film_selected_item, m_sort_order));
COMPILE_ASSERT(0x2B0 == OFFSETOF(c_gui_saved_film_selected_item, m_category));
...
COMPILE_ASSERT(sizeof(c_gui_saved_film_subitem_datasource) == 0x1D8D0);
COMPILE_ASSERT(sizeof(c_gui_saved_film_subitem_datasource) == sizeof(c_gui_ordered_data) + 0x1D7C4);
COMPILE_ASSERT(0x00110 == OFFSETOF(c_gui_saved_film_subitem_datasource, m_saved_films));
COMPILE_ASSERT(0x19B98 == OFFSETOF(c_gui_saved_film_subitem_datasource, m_saved_film_count));
COMPILE_ASSERT(0x19B9C == OFFSETOF(c_gui_saved_film_subitem_datasource, m_category));
COMPILE_ASSERT(0x19BA0 == OFFSETOF(c_gui_saved_film_subitem_datasource, m_controller_index));
COMPILE_ASSERT(0x19BA4 == OFFSETOF(c_gui_saved_film_subitem_datasource, m_enumeration_complete));
COMPILE_ASSERT(0x19BA8 == OFFSETOF(c_gui_saved_film_subitem_datasource, m_autosave_enumerator));
...
public:
	...
	COMPILE_ASSERT(sizeof(s_film_category) == 0x268);
...
COMPILE_ASSERT(sizeof(c_gui_saved_film_category_datasource) == 0x1454);
//COMPILE_ASSERT(sizeof(c_gui_saved_film_category_datasource) == sizeof(c_gui_ordered_data) + 0x1348);
