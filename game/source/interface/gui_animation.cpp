...
gui_real_rectangle2d* gui_real_rectangle2d::apply_projection_transform(real32 depth, rectangle2d const* window_bounds)
{
...
{
	return (real32)DECLFUNC(0x00B17A90, real64, __thiscall, gui_real_rectangle2d const*)(this);
}

real32 gui_real_rectangle2d::get_width() const
{
	return (real32)DECLFUNC(0x00B17AE0, real64, __thiscall, gui_real_rectangle2d const*)(this);
}
...
gui_real_rectangle2d* gui_real_rectangle2d::rotate_about_local_point(real_point2d const* local_point, real32 angle_radians)
{
	//return INVOKE_CLASS_MEMBER(0x00B17C10, gui_real_rectangle2d, rotate_about_local_point, local_point, angle_radians);
	return DECLFUNC(0x00B17C10, gui_real_rectangle2d*, __thiscall, gui_real_rectangle2d*, real_point2d const*, real32)(this, local_point, angle_radians);
}

gui_real_rectangle2d* gui_real_rectangle2d::rotate_about_local_point(real_point2d const* local_point, real32 sine_angle, real32 cosine_angle)
{
	//return INVOKE_CLASS_MEMBER(0x00B17DC0, gui_real_rectangle2d, rotate_about_local_point, local_point, sine_angle, cosine_angle);
	return DECLFUNC(0x00B17DC0, gui_real_rectangle2d*, __thiscall, gui_real_rectangle2d*, real_point2d const*, real32, real32)(this, local_point, sine_angle, cosine_angle);
}
