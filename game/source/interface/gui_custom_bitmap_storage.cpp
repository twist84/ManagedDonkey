...
bool __thiscall c_gui_custom_bitmap_storage_item::load_from_buffer(char const* buffer, long buffer_size, void* buffer2, long buffer2_size, long a6)
{
	...
	if (d3d_texture == NULL)
	{
		ERROR_EVENT("ui:custom_bitmaps: d3d_texture is null");
		return false;
	}
	...
	{
		ERROR_EVENT("ui:custom_bitmaps: D3DXLoadSurfaceFromFile failed with error code 0x%08X", load_surface_result);
		return false;
	}
