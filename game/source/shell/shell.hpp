...
extern const char* k_network_session_mode_names[k_network_session_mode_count];
extern const char* k_ui_game_mode_names[k_gui_game_setup_mode_count];
extern const char* k_gui_network_session_advertisement_mode_names[k_network_session_advertisement_mode_count];
extern const char* k_game_variant_parameter_names[k_number_of_editable_game_variant_parameters];
...
extern const char* global_voice_output_setting_names[k_number_of_voice_output_settings];
extern const char* global_voice_mask_names[k_number_of_voice_masks];
extern const char* global_subtitle_setting_names[k_number_of_subtitle_settings];
extern const char* global_actor_type_names[k_number_of_actor_types];
extern const char* global_model_state_names[k_number_of_model_states];
extern const char* global_character_physics_override_names[k_total_character_physics_overrides];
extern const char* global_primary_skull_names[k_campaign_skull_primary_count];
extern const char* global_secondary_skull_names[k_campaign_skull_secondary_count];
