...
extern void __cdecl bink_playback_dispose_from_old_structure_bsp(uint32 deactivating_structure_bsp_mask);
...
extern void __cdecl bink_playback_initialize_for_new_structure_bsp(uint32 activating_structure_bsp_mask);
...
extern void __cdecl bink_playback_prepare_for_new_zone_set(uint32 old_active_structure_bsp_mask, uint32 new_active_structure_bsp_mask);
