...
extern void __cdecl bink_playback_dispose_from_old_non_bsp_zone_set(s_game_non_bsp_zone_set const* non_bsp_zone_set);
extern void __cdecl bink_playback_dispose_from_old_structure_bsp(dword structure_bsp_mask);
...
extern void __cdecl bink_playback_initialize_for_new_non_bsp_zone_set(s_game_non_bsp_zone_set const* non_bsp_zone_set);
extern void __cdecl bink_playback_initialize_for_new_structure_bsp(dword structure_bsp_mask);
...
extern void __cdecl bink_playback_prepare_for_non_bsp_zone_set_switch(s_game_non_bsp_zone_set const* a1, s_game_non_bsp_zone_set const* a2, c_scenario_resource_registry* resource_registry);
