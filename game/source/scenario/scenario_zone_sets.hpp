...
extern const char* scenario_get_designer_zone_name(struct scenario* scenario, int32 designer_zone_index);
extern const char* scenario_get_cinematic_zone_name(struct scenario* scenario, int32 cinematic_zone_index);
