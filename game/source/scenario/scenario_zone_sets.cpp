...
//.text:005FB160 ; bool __cdecl flags_are_subset_of(dword, dword)

dword __cdecl scenario_zone_set_bsp_active_mask_get(long zone_set_index)
{
	return INVOKE(0x005FB180, scenario_zone_set_bsp_active_mask_get, zone_set_index);
}

dword __cdecl scenario_zone_set_cinematic_zone_required_mask_get(long zone_set_index)
{
...
dword __cdecl scenario_zone_set_designer_zone_required_mask_get(long zone_set_index)
{
	return INVOKE(0x005FB240, scenario_zone_set_designer_zone_required_mask_get, zone_set_index);
}

//.text:005FB290 ; dword __cdecl scenario_zone_set_get_valid_designer_zones(long, dword)
