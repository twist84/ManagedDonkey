...
extern void __cdecl scenario_prepare_for_map_reset(short zone_set_index);
...
extern char const* scenario_get_designer_zone_string_from_mask(dword mask, char* designer_zone_string, dword designer_zone_string_size);
extern char const* scenario_get_cinematic_zone_string_from_mask(dword mask, char* cinematic_zone_string, dword cinematic_zone_string_size);
