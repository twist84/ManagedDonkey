...
extern bool __cdecl scenario_modify_zone_activation_internal(int32 new_zone_set_index, uint32 old_structure_bsp_mask, uint32 new_structure_bsp_mask, uint32 new_touched_bsp_mask, s_scenario_zone_change const* non_bsp_zone_change, uint32 new_touched_cinematics_mask, bool unload_old_bsps);
