...
extern void __cdecl scenario_dispose_from_old_structure_bsp(dword structure_bsp_mask);
...
extern void __cdecl scenario_initialize_for_new_structure_bsp(dword structure_bsp_mask);
