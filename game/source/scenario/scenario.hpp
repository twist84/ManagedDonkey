...
extern char const* __cdecl scenario_get_cinematic_zone_string_from_mask(uns32 cinematic_zone_mask, char* cinematic_zone_string, uns32 cinematic_zone_string_size);
extern s_game_globals* __cdecl scenario_get_game_globals();
extern int32 __cdecl scenario_get_designer_zone_index_by_name(struct scenario const* scenario, char const* name);
extern char const* __cdecl scenario_get_designer_zone_string_from_mask(uns32 designer_zone_mask, char* designer_zone_string, uns32 designer_zone_string_size);
extern void __cdecl scenario_get_global_zone_state(s_scenario_zone_state* global_zone_state);
extern char const* __cdecl scenario_get_structure_bsp_string_from_mask(uns32 structure_bsp_mask, char* structure_bsp_string, uns32 structure_bsp_string_size);
extern int32 __cdecl scenario_get_zone_set_index_by_name(struct scenario const* scenario, char const* name, bool strip_path);
...
extern bool __cdecl scenario_modify_zone_activation_internal(int32 new_zone_set_index, uns32 old_structure_bsp_mask, uns32 new_structure_bsp_mask, uns32 new_touched_bsp_mask, s_scenario_zone_change const* non_bsp_zone_change, uns32 new_touched_cinematics_mask, bool unload_old_bsps);
extern int16 __cdecl scenario_object_name_index_from_string(struct scenario* scenario, char const* name);
...
extern char const* __cdecl scenario_tag_get_structure_bsp_name(int32 scenario_index, int32 structure_bsp_index);
...
extern void __cdecl scenario_zone_set_debug_status(char const* status, int32 zone_set_index);
...
extern structure_bsp const* __cdecl scenario_structure_bsp_get(struct scenario const* scenario, int32 structure_bsp_index);
