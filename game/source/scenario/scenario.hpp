...
extern s_scenario* __cdecl global_scenario_get();
extern int32 __cdecl global_scenario_index_get();
extern s_scenario* __cdecl global_scenario_try_and_get();
...
extern int32 __cdecl scenario_get_designer_zone_index_by_name(const s_scenario* scenario, const char* name);
...
extern int32 __cdecl scenario_get_zone_set_index_by_name(const s_scenario* scenario, const char* name, bool strip_path);
...
extern int16 __cdecl scenario_object_name_index_from_string(s_scenario* scenario, const char* name);
...
extern const structure_bsp* __cdecl scenario_structure_bsp_get(const s_scenario* scenario, int32 structure_bsp_index);
extern int32 __cdecl scenario_zone_set_structure_bsp_cluster_visible_sky_index_get(const s_scenario* scenario, int32 zone_set_index, int32 structure_bsp_index, int32 cluster_index);
