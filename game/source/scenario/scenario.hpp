...
extern dword __cdecl global_structure_bsp_active_mask_get();
...
extern char const* __cdecl scenario_get_cinematic_zone_string_from_mask(dword cinematic_zone_mask, char* cinematic_zone_string, dword cinematic_zone_string_size);
...
extern char const* __cdecl scenario_get_designer_zone_string_from_mask(dword designer_zone_mask, char* designer_zone_string, dword designer_zone_string_size);
extern void __cdecl scenario_get_global_zone_state(s_scenario_zone_state* global_zone_state);
extern char const* __cdecl scenario_get_structure_bsp_string_from_mask(dword structure_bsp_mask, char* structure_bsp_string, dword structure_bsp_string_size);
