...
extern bool __cdecl scenario_modify_zone_activation_internal(long zone_set_index, dword old_structure_bsp_mask, dword new_structure_bsp_mask, dword touched_structure_bsp_mask, s_scenario_zone_change const* zone_change, dword touched_cinematic_zone_mask, bool a7);
