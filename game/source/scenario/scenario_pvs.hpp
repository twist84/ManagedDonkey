...
extern bool __cdecl scenario_zone_set_pvs_row_test(int32 scenario_index, const s_scenario_pvs_row* pvs_row, s_cluster_reference cluster_reference);
extern void __cdecl scenario_zone_set_pvs_write_row(s_game_cluster_bit_vectors* v0, const s_scenario_pvs_row* v1);
