...
public:
	...
	virtual bool entity_update_encode(bool, uint32, uint32*, int32, void const*, s_simulation_view_telemetry_data const*, c_bitstream*, int32, bool) = 0;
	virtual bool entity_update_decode(bool, uint32*, int32, void*, c_bitstream*, bool) = 0;
	...
	virtual bool build_updated_state_data(s_simulation_entity const*, uint32*, int32, void*) = 0;
	...
	virtual void prepare_state_data_for_gameworld(uint32, int32, void*) = 0;
	virtual bool create_game_entity(int32, int32, void const*, uint32, int32, void const*) = 0;
	virtual bool update_game_entity(int32, uint32, int32, void const*) = 0;
