...
public:
	...
	virtual qword& initial_update_mask(qword& mask) = 0;
	...
	virtual bool entity_update_encode(bool, dword, dword*, long, void const*, s_simulation_view_telemetry_data const*, c_bitstream*, long, bool) = 0;
	virtual bool entity_update_decode(bool, dword*, long, void*, c_bitstream*, bool) = 0;
	...
	virtual bool build_updated_state_data(s_simulation_entity const*, dword*, long, void*) = 0;
	...
	virtual void prepare_state_data_for_gameworld(dword, long, void*) = 0;
	virtual bool create_game_entity(long, long, void const*, dword, long, void const*) = 0;
	virtual bool update_game_entity(long, dword, long, void const*) = 0;
