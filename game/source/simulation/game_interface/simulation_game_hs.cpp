...
int32 c_simulation_hs_script_wake_event_definition::minimum_required_bits(c_replication_outgoing_event const*, s_simulation_view_telemetry_data const*, int32*)
{
	return 42;
}
...
void c_simulation_hs_script_wake_event_definition::write_description_to_string(c_replication_outgoing_event const* a1, s_simulation_view_telemetry_data const* a2, real32 a3, int32 buffer_count, char* buffer)
{
...
void c_simulation_hs_script_wake_event_definition::event_payload_encode(int32 payload_size, void const* payload, c_bitstream* packet)
{
...
bool c_simulation_hs_script_wake_event_definition::apply_game_event(int32 entity_reference_count, int32 const*, int32 payload_size, void const* payload)
{
