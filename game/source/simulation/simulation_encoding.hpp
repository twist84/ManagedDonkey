...
extern bool __cdecl simulation_update_compare(const struct simulation_update* update1, struct simulation_update* update2);
extern bool __cdecl simulation_update_decode(c_bitstream* packet, struct simulation_update* update);
extern void __cdecl simulation_update_encode(c_bitstream* packet, const struct simulation_update* update);
