...
void __cdecl simulation_player_collection_apply_update(s_player_collection* collection, simulation_player_update const* player_update)
{
	...
	//VERBOSE_EVENT("networking:simulation:players: player-collection test-applying type %d to player %d at time %d",
	//	type,
...
bool __cdecl simulation_player_update_apply_added(simulation_player_update const* player_update)
{
	...
	//if (!player)
	//{
	//	ERROR_EVENT("networking:simulation:players:apply-configuration: simulation asked us to update unknown player [#%d]",
	//		player_update->player_index);
	//
	//	return false;
	//}
	...
	//{
	//	ERROR_EVENT("networking:simulation:players:apply-configuration: identifier mismatch updating player [#%d]",
	//		player_update->player_index);
	//
	//	return false;
	//}
	...
	//
	//MESSAGE_EVENT("networking:simulation:players:apply-configuration: player [#%d] configuration updated",
	//	player_update->player_index);
	//
	//return true;
}
...
bool __cdecl simulation_players_apply_update(simulation_player_update const* player_update)
{
	...
	//
	//e_simulation_player_update_type type = player_update->update_type;
	//VERBOSE_EVENT("networking:simulation:players: for-real applying type %d to player %d at time %d",
	//	type,
	//	player_update->player_index,
	//	game_time_get());
	//
