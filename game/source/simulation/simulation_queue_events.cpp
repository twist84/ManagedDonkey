...
bool __cdecl encode_event_to_buffer(byte* buffer, int32 buffer_size, int32* size_out, e_simulation_event_type event_type, int32 reference_count, const int32* references, const void* payload, int32 payload_size)
{
