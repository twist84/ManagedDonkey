...
{
	struct s_simulation_hs_script_wake_event_definition
	{
		char script_name[32];
		long script_index;
	};
	static_assert(sizeof(s_simulation_hs_script_wake_event_definition) == 0x24);
	...
	{
		return sizeof(s_simulation_hs_script_wake_event_definition);
	}
