...
{
public:
	virtual e_simulation_event_type __cdecl event_type();
	virtual char const* __cdecl event_type_name();
	virtual long __cdecl payload_size();
	virtual long __cdecl number_of_entity_references();
	virtual bool __cdecl reference_delays_entity_deletion();
	virtual bool __cdecl event_can_be_transmitted(c_replication_outgoing_event const*, s_simulation_view_telemetry_data const*);
	virtual void __cdecl minimum_required_bits(c_replication_outgoing_event const*, s_simulation_view_telemetry_data const*, long*);
	virtual float __cdecl calculate_relevance(c_replication_outgoing_event const*, s_simulation_view_telemetry_data const*, float);
	virtual void __cdecl write_description_to_string(c_replication_outgoing_event const*, s_simulation_view_telemetry_data const*, float, long, char*);

	// TODO: figure it out
	virtual void* __cdecl __func9(void*, ...);

	virtual void __cdecl event_payload_encode(long, void const*, c_bitstream*, bool);
	virtual bool __cdecl event_payload_decode(long, void*, c_bitstream*, bool);
	virtual void __cdecl prepare_event_data_for_gameworld(long, void*);
	virtual bool __cdecl apply_game_event(long, long const*, long, void const*);
