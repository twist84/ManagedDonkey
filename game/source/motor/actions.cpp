...
//.text:00B69B20 ; bool __cdecl action_allow_interruption(e_action, e_action, c_flags<e_action_interruption_context, uns16, 2> const*)
//.text:00B69BA0 ; bool __cdecl action_executing(int32, e_action)
...
// dummy declaration
bool __cdecl action_submit0(int32 mover_index, action_request const* request);
bool __cdecl action_submit(int32 mover_index, action_request const* request)
{
