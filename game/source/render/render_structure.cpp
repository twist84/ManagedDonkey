...
void __cdecl c_structure_renderer::dispose_from_old_structure_bsp(dword deactivating_structure_bsp_mask)
{
...
void __cdecl c_structure_renderer::initialize_for_new_structure_bsp(dword activating_structure_bsp_mask)
{
