...
REFERENCE_DECLARE(0x0191816C, real32, shadow_reduce_distance_scale) = 1.01f;
REFERENCE_DECLARE(0x01918170, real32, shadow_decrease_distance_blend) = 0.99f;
REFERENCE_DECLARE(0x05115B3E, bool, c_lightmap_shadows_view::g_debug_shadow_bounds) = true;
REFERENCE_DECLARE(0x05115B3F, bool, c_lightmap_shadows_view::g_debug_shadow_bounds_solid) = true;
