...
//render_debug_spray
extern void __cdecl render_debug_point2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* point, real32 scale, real_argb_color const* color, real32 a8);
extern void __cdecl render_debug_line2d(real_point2d const* point0, real_point2d const* point1, real_argb_color const* color);
extern void __cdecl render_debug_line2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* p0, real_point2d const* p1, real_argb_color const* color, real32 a8);
extern void __cdecl render_debug_vector2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* point, real_vector2d const* vector, real32 scale, real_argb_color const* color, real32 a9);
extern void __cdecl render_debug_circle(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* center, real32 radius, real_argb_color const* color, real32 a8);
...
extern void __cdecl render_debug_polygon_regular(bool draw_immediately, real_point3d const* center, long point_count, real_vector3d const* normal, real32 radius, real_argb_color const* color);
...
extern void __cdecl render_debug_build_circle_points(real32 radius, real_point2d* points, long total_point_count);
