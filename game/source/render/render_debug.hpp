...
//render_debug_spray
extern void __cdecl render_debug_point2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* point, real scale, real_argb_color const* color, real a8);
extern void __cdecl render_debug_line2d(real_point2d const* point0, real_point2d const* point1, real_argb_color const* color);
extern void __cdecl render_debug_line2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* p0, real_point2d const* p1, real_argb_color const* color, real a8);
extern void __cdecl render_debug_vector2d(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* point, real_vector2d const* vector, real scale, real_argb_color const* color, real a9);
extern void __cdecl render_debug_circle(bool draw_immediately, real_plane3d const* plane, short projection_axis, bool projection_sign, real_point2d const* center, real radius, real_argb_color const* color, real a8);
extern void __cdecl render_debug_circle(bool draw_immediately, real_point3d const* center, real_vector3d const* normal, real radius, real_argb_color const* color);
extern void __cdecl render_debug_polygon_regular(bool draw_immediately, real_point3d const* center, long point_count, real_vector3d const* normal, real radius, real_argb_color const* color);
...
extern void __cdecl render_debug_vector(bool draw_immediately, real_point3d const* point, real_vector3d const* vector, real scale, real_argb_color const* color);
extern void __cdecl render_debug_tick(bool draw_immediately, real_point3d const* point, real_vector3d const* vector, real scale, real_argb_color const* color);
...
extern void __cdecl render_debug_vectors(bool draw_immediately, real_point3d const* point, real_vector3d const* forward, real_vector3d const* up, real radius);
...
extern void __cdecl render_debug_matrix3x3(bool draw_immediately, real_matrix3x3 const* matrix, real_point3d const* point, real radius);
...
extern void __cdecl render_debug_cylinder(bool draw_immediately, real_point3d const* base, real_vector3d const* height, real radius, real_argb_color const* color);
extern void __cdecl render_debug_pill(bool draw_immediately, real_point3d const* base, real_vector3d const* height, real radius, real_argb_color const* color);
...
extern real __cdecl build_height_matrix(real_point3d const* base, real_vector3d const* height, real_matrix4x3* out_matrix);
extern void __cdecl render_debug_build_circle_points(real radius, real_point2d* points, long total_point_count);
extern void __cdecl render_debug_build_pill_points(real_point3d const* base, real_vector3d const* height, real radius, real_point3d* points0, real_point3d* points1, real_point3d* points2, real_point3d* points3, real_point3d* points4, real_point3d* points5);
