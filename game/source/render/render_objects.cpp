...
//.text:00A781A0 ; public: static void __cdecl c_render_flags::or_window_bit(c_render_flags::e_window_bit, dword)
...
void __cdecl c_object_renderer::render_albedo(dword mesh_part_flags)
{
...
//.text:00A786B0 ; public: static void __cdecl c_object_renderer::render_object_context_instances(s_context_mesh_part const*, e_entry_point, dword const*, s_lod_transparency, long)
...
//.text:00A796E0 ; public: static void __cdecl c_object_renderer::submit_object_hierarchy(long, long, s_lod_transparency, long, dword)
//.text:00A798B0 ; public: static void __cdecl c_object_renderer::submit_object_hierarchy_for_special_traits_recursive(long*, long*, long, render_lighting*, s_lod_transparency, long, real_point3d*, dword)
//.text:00A79BA0 ; public: static void __cdecl c_object_renderer::submit_object_hierarchy_recursive(long*, long*, long, s_object_render_context*, long, dword, dword*)
...
//.text:00A7A4F0 ; 
//.text:00A7A510 ; public: static void __cdecl c_object_renderer::submit_visibility(dword)
