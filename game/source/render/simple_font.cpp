...
void __cdecl simple_font::draw_quads(rasterizer_vertex_screen* triangle_vertices, long verts_used, bool apply_display_scalar_correction)
{
...
long __cdecl simple_font::get_height()
{
...
void __cdecl simple_font::print_white(long x, long y, char const* c, long count)
{
...
//.text:00A771D0
void __cdecl simple_font::printf(long x, long y, char const* c, ...)
{
	va_list va;
	va_start(va, c);
