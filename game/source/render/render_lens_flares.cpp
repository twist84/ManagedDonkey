...
//.text:00A58B30 ; bool __cdecl lens_flare_evaluate_parameters(long, long, long, real, real_vector4d const*, bool, s_lens_flare_render_parameters*)
...
//.text:00A596D0 ; bool __cdecl lens_flare_project_billboard(real_point3d const*, real, real_vector2d const*, bool, real_vector4d*, real_vector2d*, real_vector2d*)

void __cdecl lens_flare_render_internal(long user_index, long lens_flare_index, real opacity, long conditional_rendering_index, bool screen_facing)
{
...
long __cdecl lens_flares_create(long definition_index, e_lens_flare_attachment_types attachment_type, long attachment_index, word attachment_subindex, real_point3d const* position, real_vector3d const* forward, real_rgb_color const* tint_color, real age_function_input, real scale, real marker_scale, bool first_person, long user_index)
{
...
long __cdecl lens_flares_create_internal(long definition_index, e_lens_flare_attachment_types attachment_type, long attachment_index, word attachment_subindex, real_point3d const* position, real_vector3d const* forward, real_rgb_color const* tint_color, real age_function_input, real scale, real marker_scale, bool first_person, long user_index)
{
...
//.text:00A5A4B0 ; real __cdecl lens_flares_evaluate_corona_rotation_function(long function, real scale_in_radians, real_point3d const* position, real_vector3d const* forward)
