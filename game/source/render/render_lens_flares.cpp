...
void __cdecl lens_flare_render_occlusion(int32 lens_flare_index)
{
...
int32 __cdecl lens_flares_create(int32 definition_index, e_lens_flare_attachment_types attachment_type, int32 attachment_index, uint16 attachment_subindex, real_point3d const* position, real_vector3d const* forward, real_rgb_color const* tint_color, real32 age_function_input, real32 scale, real32 marker_scale, bool first_person, int32 user_index)
{
	...
	int32 result = lens_flares_create_internal(definition_index, attachment_type, attachment_index, attachment_subindex, position, forward, tint_color, age_function_input, scale, marker_scale, first_person, user_index);
	return result;
}
...
void __cdecl lens_flares_render(int32 user_index)
{
...
void __cdecl lens_flares_submit_occlusions(int32 user_index, e_lens_flare_occlusion_rendering_types rendering_type)
{
