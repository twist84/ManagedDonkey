...
extern int32 __cdecl lens_flares_create(int32 definition_index, e_lens_flare_attachment_types attachment_type, int32 attachment_index, uint16 attachment_subindex, real_point3d const* position, real_vector3d const* forward, real_rgb_color const* tint_color, real32 age_function_input, real32 scale, real32 marker_scale, bool first_person, int32 user_index);
extern int32 __cdecl lens_flares_create_internal(int32 definition_index, e_lens_flare_attachment_types attachment_type, int32 attachment_index, uint16 attachment_subindex, real_point3d const* position, real_vector3d const* forward, real_rgb_color const* tint_color, real32 age_function_input, real32 scale, real32 marker_scale, bool first_person, int32 user_index);
