...
void __cdecl bitmap_2d_initialize(bitmap_data* bitmap, int16 width, int16 height, int16 mipmap_count, int16 format, uns16 flags, bool a7, bool a8)
{
	INVOKE(0x0086AAE0, bitmap_2d_initialize, bitmap, width, height, mipmap_count, format, flags, a7, a8);
}

bitmap_data* __cdecl bitmap_2d_new(int16 width, int16 height, int16 mipmap_count, int16 format, uns16 flags)
{
