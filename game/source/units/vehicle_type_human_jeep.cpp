...
void c_vehicle_type_human_jeep::create_effects(long vehicle_index)
{
	INVOKE_CLASS_MEMBER(0x00BC8BC0, c_vehicle_type_human_jeep, create_effects, vehicle_index);
}
...
bool c_vehicle_type_human_jeep::effected_by_vehicle_ceiling(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BC8BF0, c_vehicle_type_human_jeep, effected_by_vehicle_ceiling, vehicle_index);
}
...
bool c_vehicle_type_human_jeep::is_e_braking(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BC8C20, c_vehicle_type_human_jeep, is_e_braking, vehicle_index);
}
...
bool c_vehicle_type_human_jeep::kills_riders_at_terminal_velocity(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BC8C90, c_vehicle_type_human_jeep, kills_riders_at_terminal_velocity, vehicle_index);
}

bool c_vehicle_type_human_jeep::physics_disabled(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BC8CA0, c_vehicle_type_human_jeep, physics_disabled, vehicle_index);
}
...
bool c_vehicle_type_human_jeep::vector_is_upsides_down(long vehicle_index, vector3d const* vector)
{
	return INVOKE_CLASS_MEMBER(0x00BC9670, c_vehicle_type_human_jeep, vector_is_upsides_down, vehicle_index, vector);
}
