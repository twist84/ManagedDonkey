...
void __cdecl unit_get_aiming_vector(long unit_index, real_vector3d* aiming_vector)
{
...
//.text:00B48590 ; void __cdecl unit_set_aiming_vectors(long, real_vector3d const*, real_vector3d const*)
...
bool __cdecl unit_unsuspecting(long unit_index, real_point3d const* attacker_position, real_vector3d const* attacker_direction)
{
...
void __cdecl unit_update_illumination(long unit_index)
{
	if (debug_unit_illumination)
	{
		...
		if (unit->unit.player_index != NONE)
		{
			...
			{
				WARNING_EVENT("player illumination: self %.2f ambient %.2f",
