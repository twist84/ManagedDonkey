...
//.text:00BEC6B0 ; int16 __cdecl vehicle_engine_get_desired_gear(s_vehicle_engine const*, s_vehicle_engine_definition const*, real32, bool, bool, bool)
...
//.text:00BECA50 ; void __cdecl vehicle_engine_update(int32, s_vehicle_engine*, s_vehicle_engine_definition const*, real32, int16, bool)
//.text:00BECE10 ; real32 __cdecl vehicle_get_gear_ratio(s_vehicle_engine const*, s_vehicle_engine_definition const*, int16)
//.text:00BECE60 ; real32 __cdecl vehicle_get_torque_from_angular_velocity(s_vehicle_engine const*, s_vehicle_engine_definition const*, int16, real32)
