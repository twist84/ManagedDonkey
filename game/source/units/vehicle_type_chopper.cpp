...
void c_vehicle_type_chopper::adjust_gravity(long vehicle_index, vector3d* gravity_acceleration)
{
	INVOKE_CLASS_MEMBER(0x00BD37B0, c_vehicle_type_chopper, adjust_gravity, vehicle_index, gravity_acceleration);
}
...
void c_vehicle_type_chopper::create_effects(long vehicle_index)
{
	INVOKE_CLASS_MEMBER(0x00BD3C80, c_vehicle_type_chopper, create_effects, vehicle_index);
}
...
bool c_vehicle_type_chopper::effected_by_vehicle_ceiling(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD3CB0, c_vehicle_type_chopper, effected_by_vehicle_ceiling, vehicle_index);
}
...
bool c_vehicle_type_chopper::kills_riders_at_terminal_velocity(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD3D50, c_vehicle_type_chopper, kills_riders_at_terminal_velocity, vehicle_index);
}

bool c_vehicle_type_chopper::physics_disabled(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD3D60, c_vehicle_type_chopper, physics_disabled, vehicle_index);
}
...
bool c_vehicle_type_chopper::vector_is_upsides_down(long vehicle_index, vector3d const* vector)
{
	return INVOKE_CLASS_MEMBER(0x00BD52C0, c_vehicle_type_chopper, vector_is_upsides_down, vehicle_index, vector);
}
