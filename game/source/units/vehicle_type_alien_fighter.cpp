...
void c_vehicle_type_alien_fighter::adjust_gravity(long vehicle_index, vector3d* gravity_acceleration)
{
...
bool c_vehicle_type_alien_fighter::compute_reference_and_trick_rotation(long vehicle_index, s_havok_vehicle_physics_instance const* instance, matrix3x3* reference_rotation, matrix3x3* trick_rotation)
{
...
void c_vehicle_type_alien_fighter::create_effects(long vehicle_index)
{
	INVOKE_CLASS_MEMBER(0x00BCD4F0, c_vehicle_type_alien_fighter, create_effects, vehicle_index);
}
...
bool c_vehicle_type_alien_fighter::effected_by_vehicle_ceiling(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BCD540, c_vehicle_type_alien_fighter, effected_by_vehicle_ceiling, vehicle_index);
}
...
bool c_vehicle_type_alien_fighter::is_stopped(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BCD5F0, c_vehicle_type_alien_fighter, is_stopped, vehicle_index);
}

bool c_vehicle_type_alien_fighter::kills_riders_at_terminal_velocity(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BCD600, c_vehicle_type_alien_fighter, kills_riders_at_terminal_velocity, vehicle_index);
}

bool c_vehicle_type_alien_fighter::physics_disabled(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BCD610, c_vehicle_type_alien_fighter, physics_disabled, vehicle_index);
}
...
bool c_vehicle_type_alien_fighter::vector_is_upsides_down(long vehicle_index, vector3d const* vector)
{
	return INVOKE_CLASS_MEMBER(0x00BCEBE0, c_vehicle_type_alien_fighter, vector_is_upsides_down, vehicle_index, vector);
}
