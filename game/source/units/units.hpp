...
extern void __cdecl unit_active_camouflage_ding(int32 unit_index, real32 active_camo_ding, real32 active_camo_regrowth_rate);
extern void __cdecl unit_active_camouflage_disable(int32 unit_index, real32 interpolation_time);
extern void __cdecl unit_active_camouflage_enable(int32 unit_index, real32 interpolation_time, int32 end_time);
extern void __cdecl unit_active_camouflage_strength(int32 unit_index, real32 active_camouflage);
extern void __cdecl unit_add_equipment_to_inventory(int32 unit_index, int32 slot_index, int32 object_index);
extern bool __cdecl unit_add_grenade_to_inventory(int32 unit_index, int32 object_index);
extern int16 __cdecl unit_add_grenade_type_to_inventory(int32 unit_index, int16 grenade_type, int16 grenade_count);
extern void __cdecl unit_add_starting_profile_equipment(int32 unit_index, int16 profile_index, bool clear_player, bool create_new);
...
extern int16 __cdecl unit_get_all_seats(int32 unit_index, unit_seat_source* sources, int16 maximum_source_count, bool a4);
extern void __cdecl unit_get_camera_position(int32 unit_index, real_point3d* position);
extern int32 __cdecl unit_get_current_equipment(int32 unit_index, int32 equipment_slot_index);
extern real32 __cdecl unit_get_field_of_view(int32 unit_index, real32 fov_radians, int16 zoom_level);
extern void __cdecl unit_get_head_position(int32 unit_index, real_point3d* position);
...
extern bool __cdecl unit_use_current_equipment(int32 unit_index, int32 slot_index, bool a3);
...
extern int16 __cdecl unit_weapon_next_index(int32 unit_index, int32 a2, int16 a3, int16 a4);
