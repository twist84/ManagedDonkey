...
extern void __cdecl unit_drop_current_equipment(int32 unit_index, int32 slot_index);
extern void __cdecl unit_drop_item(int32 unit_index, int32 item_index, e_unit_drop_type drop_type);
