...
bool __cdecl c_vehicle_type_mantis::compute_function_value(long vehicle_index, long function, real32* magnitude, bool* force_active)
{
...
void __cdecl c_vehicle_type_mantis::process_animation_channels(long vehicle_index, void(__cdecl* callback)(long, render_model_definition const*, c_animation_channel*, real32, real32, real32, void*), void* user_data, c_animation_channel* channel, bool find_animations)
{
...
void c_vehicle_type_mantis::update_leg_turn_and_displacment(long vehicle_index, real32* final_turn, real_vector3d* final_leg_displacement, real_vector3d* displacement_delta, bool* same_displacement)
{
...
void c_vehicle_type_mantis::update_movement_leg_turn_and_displacment(long vehicle_index, real32* final_turn, real_vector3d* final_leg_displacement)
{
