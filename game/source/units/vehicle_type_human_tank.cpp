...
void __cdecl c_vehicle_type_human_tank::adjust_gravity(long vehicle_index, vector3d* gravity_acceleration)
{
...
bool __cdecl c_vehicle_type_human_tank::vector_is_upsides_down(long vehicle_index, vector3d const* vector)
{
