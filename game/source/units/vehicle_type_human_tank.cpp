...
void __cdecl c_vehicle_type_human_tank::adjust_gravity(long vehicle_index, real_vector3d* gravity_acceleration)
{
...
bool c_vehicle_type_human_tank::compute_function_value(long vehicle_index, long function, real32* magnitude, bool* force_active)
{
...
void c_vehicle_type_human_tank::compute_tread_speeds(long vehicle_index, real32* left_tread_speed, real32* right_tread_speed)
{
...
void __cdecl c_vehicle_type_human_tank::create_effects(long vehicle_index)
{
...
bool __cdecl c_vehicle_type_human_tank::effected_by_vehicle_ceiling(long vehicle_index)
{
...
bool __cdecl c_vehicle_type_human_tank::kills_riders_at_terminal_velocity(long vehicle_index)
{
...
bool __cdecl c_vehicle_type_human_tank::physics_disabled(long vehicle_index)
{
...
void __cdecl c_vehicle_type_human_tank::process_animation_channels(long vehicle_index, void(__cdecl* callback)(long, render_model_definition const*, c_animation_channel*, real32, real32, real32, void*), void* user_data, c_animation_channel* channel, bool find_animations)
{
...
bool __cdecl c_vehicle_type_human_tank::vector_is_upsides_down(long vehicle_index, real_vector3d const* vector)
{
