...
void c_vehicle_type_guardian::adjust_gravity(long vehicle_index, vector3d* gravity_acceleration)
{
	INVOKE_CLASS_MEMBER(0x00BD0050, c_vehicle_type_guardian, adjust_gravity, vehicle_index, gravity_acceleration);
}

bool c_vehicle_type_guardian::compute_function_value(long vehicle_index, long function, real* magnitude, bool* force_active)
{
	return INVOKE_CLASS_MEMBER(0x00BD0060, c_vehicle_type_guardian, compute_function_value, vehicle_index, function, magnitude, force_active);
}

void c_vehicle_type_guardian::create_effects(long vehicle_index)
{
	INVOKE_CLASS_MEMBER(0x00BD0070, c_vehicle_type_guardian, create_effects, vehicle_index);
}
...
bool c_vehicle_type_guardian::effected_by_vehicle_ceiling(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD0090, c_vehicle_type_guardian, effected_by_vehicle_ceiling, vehicle_index);
}
...
bool c_vehicle_type_guardian::is_stopped(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD00F0, c_vehicle_type_guardian, is_stopped, vehicle_index);
}

bool c_vehicle_type_guardian::kills_riders_at_terminal_velocity(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD0100, c_vehicle_type_guardian, kills_riders_at_terminal_velocity, vehicle_index);
}

bool c_vehicle_type_guardian::physics_disabled(long vehicle_index)
{
	return INVOKE_CLASS_MEMBER(0x00BD0110, c_vehicle_type_guardian, physics_disabled, vehicle_index);
}
...
bool c_vehicle_type_guardian::vector_is_upsides_down(long vehicle_index, vector3d const* vector)
{
	return INVOKE_CLASS_MEMBER(0x00BD0C20, c_vehicle_type_guardian, vector_is_upsides_down, vehicle_index, vector);
}
